...
{
    BoundsRange l1 = BoundsRange(-7, 5);
    BoundsRange l2 = BoundsRange(5, 7);
    BoundsRange l3 = BoundsRange(-7, -5);
    BoundsRange r1 = BoundsRange(2);
    BoundsRange r2 = BoundsRange(-2);
    BoundsRange res;
...
TEST_F(BoundsAnalysisTest, LoopWithBigStep)
{
    ...
    // this loop is counable, but init + step > test value.
    GRAPH(GetGraph())
    {
        CONSTANT(0, 0);
        CONSTANT(1, 5);
