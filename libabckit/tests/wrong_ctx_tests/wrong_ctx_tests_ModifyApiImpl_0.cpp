...
class LibAbcKitWrongCtxTestsModifyApiImpl0 : public ::testing::Test {};

// Test: test-kind=api, api=ModifyApiImpl::functionSetGraph,
// abc-kind=NoABC, category=negative-file
TEST_F(LibAbcKitWrongCtxTestsModifyApiImpl0, functionSetGraph)
{
    helpers_wrong_ctx::TestWrongCtx(g_modifyApiImp->functionSetGraph);
}
