...
TEST_F(AbckitScenarioCTestClean, LibAbcKitTestDynamicRouterTableClean)
{
    std::string inputPath = ABCKIT_ABC_DIR "clean_scenarios/c_api/dynamic/router_table/router_table.abc";
    std::string outputPath = ABCKIT_ABC_DIR "clean_scenarios/c_api/dynamic/router_table/router_table_modified.abc";
