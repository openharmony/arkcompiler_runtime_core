...
bool ark::guard::NameCacheDumper::VisitMethod(abckit_wrapper::Method *method)
{
    ...
    parentObjectNameCache->methods.emplace(obfuscateData->GetName(), obfuscateData->GetObfName());
    return true;
}
...
bool ark::guard::NameCacheDumper::VisitField(abckit_wrapper::Field *field)
{
    ...
    parentObjectNameCache->fields.emplace(obfuscateData->GetName(), obfuscateData->GetObfName());
    return true;
}
