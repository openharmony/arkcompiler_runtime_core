...
#ifndef COMMON_RUNTIME_COMMON_COMPONENTS_HEAP_ARK_COLLECTOR_MOCK_BARRIER_COLLECTOR_H
#define COMMON_RUNTIME_COMMON_COMPONENTS_HEAP_ARK_COLLECTOR_MOCK_BARRIER_COLLECTOR_H
...
#endif // COMMON_RUNTIME_COMMON_COMPONENTS_HEAP_ARK_COLLECTOR_MOCK_BARRIER_COLLECTOR_H