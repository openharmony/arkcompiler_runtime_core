 ...
 */
#ifndef COMMON_RUNTIME_COMMON_COMPONENTS_HEAP_SPACE_RAWPOINTER_SPACE_H
#define COMMON_RUNTIME_COMMON_COMPONENTS_HEAP_SPACE_RAWPOINTER_SPACE_H
...
#endif // COMMON_RUNTIME_COMMON_COMPONENTS_HEAP_SPACE_RAWPOINTER_SPACE_H