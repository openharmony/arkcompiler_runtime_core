...
#ifndef COMMON_RUNTIME_COMMON_COMPONENTS_BASE_CONFIG_H
#define COMMON_RUNTIME_COMMON_COMPONENTS_BASE_CONFIG_H
...
#endif  // COMMON_RUNTIME_COMMON_COMPONENTS_BASE_CONFIG_H