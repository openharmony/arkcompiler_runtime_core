...
#ifndef COMMON_RUNTIME_COMMON_COMPONENTS_BASE_HASH_UTILS_H
#define COMMON_RUNTIME_COMMON_COMPONENTS_BASE_HASH_UTILS_H
...
#endif // COMMON_RUNTIME_COMMON_COMPONENTS_BASE_HASH_UTILS_H
