...
#ifndef COMMON_RUNTIME_COMMON_COMPONENTS_OBJECTS_STRING_TABLE_INTEGER_CACHE_H
#define COMMON_RUNTIME_COMMON_COMPONENTS_OBJECTS_STRING_TABLE_INTEGER_CACHE_H
