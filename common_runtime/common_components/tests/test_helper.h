...
#ifndef COMMON_RUNTIME_COMMON_COMPONENTS_TESTS_TEST_HELPER_H
#define COMMON_RUNTIME_COMMON_COMPONENTS_TESTS_TEST_HELPER_H
...
#endif  // COMMON_RUNTIME_COMMON_COMPONENTS_TESTS_TEST_HELPER_H
