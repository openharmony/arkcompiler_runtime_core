...
#ifndef COMMON_RUNTIME_COMMON_COMPONENTS_PLATFORM_STRING_HASH_H
#define COMMON_RUNTIME_COMMON_COMPONENTS_PLATFORM_STRING_HASH_H
...
#endif  // COMMON_RUNTIME_COMMON_COMPONENTS_PLATFORM_STRING_HASH_H
