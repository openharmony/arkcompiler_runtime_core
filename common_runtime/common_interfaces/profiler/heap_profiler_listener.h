...
#ifndef COMMON_RUNTIME_COMMON_INTERFACES_HEAP_PROFILER_LISTENER_H
#define COMMON_RUNTIME_COMMON_INTERFACES_HEAP_PROFILER_LISTENER_H
...
#endif  // COMMON_RUNTIME_COMMON_INTERFACES_HEAP_PROFILER_LISTENER_H