...
TEST_F(CommonTest, ConstArrayResolverInt64)
{
    ...
    GRAPH(graph)
    {
        ...
        BASIC_BLOCK(2, -1)
        {
            ...
            INST(5, Opcode::NewArray).ref().Inputs(4, 1, 20);
            INST(11, Opcode::StoreArray).u64().Inputs(5, 2, 2);
            INST(13, Opcode::StoreArray).u64().Inputs(5, 3, 2);
...
TEST_F(CommonTest, ConstArrayResolverInt32)
{
    ...
    GRAPH(graph)
    {
        ...
        BASIC_BLOCK(2, -1)
        {
            ...
            INST(4, Opcode::LoadAndInitClass).ref().Inputs(20).TypeId(68);
            INST(5, Opcode::NewArray).ref().Inputs(4, 1, 20);
            INST(11, Opcode::StoreArray).u32().Inputs(5, 2, 2);
            INST(13, Opcode::StoreArray).u32().Inputs(5, 3, 2);
            INST(10, Opcode::Return).ref().Inputs(5);
        }
    }
...
TEST_F(CommonTest, ConstArrayResolverOrderInt32)
{
    ...
    GRAPH(graph)
    {
        ...
        BASIC_BLOCK(2, -1)
        {
            INST(20, Opcode::SaveState).NoVregs();
            INST(4, Opcode::LoadAndInitClass).ref().Inputs(20).TypeId(68);
            INST(5, Opcode::NewArray).ref().Inputs(4, 0, 20);
            INST(15, Opcode::StoreArray).u32().Inputs(5, 2, 1);
            INST(11, Opcode::StoreArray).u32().Inputs(5, 1, 2);
            INST(13, Opcode::StoreArray).u32().Inputs(5, 3, 3);
            INST(10, Opcode::Return).ref().Inputs(5);
        }
    }
    ...
    EXPECT_TRUE(std::get<uint32_t>(lit_arr.literals[0 + offset].value) == 1);
    EXPECT_TRUE(std::get<uint32_t>(lit_arr.literals[1 + offset].value) == 0);
    EXPECT_TRUE(std::get<uint32_t>(lit_arr.literals[2 + offset].value) == 2);
}
