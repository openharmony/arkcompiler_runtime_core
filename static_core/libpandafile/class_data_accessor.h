...
#ifndef LIBPANDAFILE_CLASS_DATA_ACCESSOR_H
#define LIBPANDAFILE_CLASS_DATA_ACCESSOR_H
...
public:
    ...
    {
        const uint8_t *descriptor = GetDescriptor();
        switch (*descriptor) {
            case 'V':
                return "void";
            case 'Z':
...
#endif  // LIBPANDAFILE_CLASS_DATA_ACCESSOR_H
