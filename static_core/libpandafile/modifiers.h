...
static constexpr uint32_t ACC_PROTECTED = 0x0004;     // field, method, class
...
static constexpr uint32_t ACC_DESTROYED = 0x8000;     // method
...
static constexpr uint32_t ACC_PROFILING = 0x20000000;                 // method (runtime)
...
static constexpr uint32_t VERIFICATION_STATUS_WIDTH = 0x2;
static constexpr uint32_t VERIFICATION_STATUS_MASK = ((1U << VERIFICATION_STATUS_WIDTH) - 1U)
                                                     << VERIFICATION_STATUS_SHIFT;
