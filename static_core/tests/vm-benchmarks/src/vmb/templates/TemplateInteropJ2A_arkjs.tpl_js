...
function initEtsVm() {
    ...
    const etsVm = require(modulePath + '/ets_interop_js_napi.node');
...
function log(msg) {
    console.log(msg); // NOTE only difference with Template.mjs is console.log here instead of print
}
