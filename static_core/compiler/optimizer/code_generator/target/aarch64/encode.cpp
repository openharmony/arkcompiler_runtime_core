                                             ...
                                             vixl::aarch64::Label *label_found, vixl::aarch64::Label *label_not_found)
{
    ...
    GetMasm()->Cmp(tmp2.X(), -DOUBLE_WORD_SIZE_BYTES);
    ...
    vixl::aarch64::Label *label_not_found, vixl::aarch64::Label *label_small_loop)
{
    ...
    GetMasm()->Bind(label_loop);
    {
        ...
        GetMasm()->Add(tmp2.X(), tmp2.X(), DOUBLE_WORD_SIZE_BYTES);
        GetMasm()->Cmp(tmp2.X(), -DOUBLE_WORD_SIZE_BYTES);       // has enough bytes left to read whole register?
    ...
    GetMasm()->Mov(tmp2.X(), -DOUBLE_WORD_SIZE_BYTES);  // setup data to read last 8 bytes. One more loop
                                              ...
                                              uint32_t length_offset, uint32_t data_offset, int32_t char_const_value)
{
    ...
    ScopedTmpReg tmp3_scoped(this, true); /* LR is used */
