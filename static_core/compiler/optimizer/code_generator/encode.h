...
#undef INST_DEF
    ...
    virtual void EncodeNegOverflowAndZero([[maybe_unused]] compiler::LabelHolder::LabelId id, [[maybe_unused]] Reg dst,
                                          [[maybe_unused]] Reg src)
    {
        SetFalseResult();
    }

    virtual void EncodeFastPathDynamicCast([[maybe_unused]] Reg dst, [[maybe_unused]] Reg src,
    ...
    virtual void EncodeSti([[maybe_unused]] double src, [[maybe_unused]] MemRef mem)
    {
        SetFalseResult();
    }
    virtual void EncodeSti([[maybe_unused]] float src, [[maybe_unused]] MemRef mem)
    {
        SetFalseResult();
    }
    ...
    virtual void EncodeIsInteger([[maybe_unused]] Reg dst, [[maybe_unused]] Reg src0)
    {
        SetFalseResult();
    }

    virtual void EncodeIsSafeInteger([[maybe_unused]] Reg dst, [[maybe_unused]] Reg src0)
    {
        SetFalseResult();
    }
    ...
    virtual void EncodeTrunc([[maybe_unused]] Reg dst, [[maybe_unused]] Reg src)
    {
        SetFalseResult();
    }

    virtual void EncodeRoundAway([[maybe_unused]] Reg dst, [[maybe_unused]] Reg src)
    {
        SetFalseResult();
    }

    virtual void EncodeRoundToPInf([[maybe_unused]] Reg dst, [[maybe_unused]] Reg src)
    {
        SetFalseResult();
    }
    ...
    virtual void EncodeMemoryBarrier([[maybe_unused]] memory_order::Order order)
    {
        SetFalseResult();
    }
