...
TEST_F(DeoptimizeEliminationTest, ChaGuardOneBlockCallInlinedTest)
{
    GRAPH(GetGraph())
    {
        ...
        BASIC_BLOCK(2, 1)
        {
            ...
            INST(7, Opcode::ReturnInlined).Inputs(20);
...
TEST_F(DeoptimizeEliminationTest, ChaGuardIfSeveralGuardsTest)
{
    ...
    GRAPH(GetGraph())
    {
        ...
        BASIC_BLOCK(4, 5)
        {
            ...
            INST(16, Opcode::ReturnInlined).Inputs(21);
        }
        BASIC_BLOCK(5, 1)
        {
            INST(6, Opcode::SaveStateDeoptimize).Inputs(10, 11).SrcVregs({0, 1});
...
TEST_F(DeoptimizeEliminationTest, ReplaceByDeoptimizeInliningTest)
{
    ...
    INS(4).CastToSaveState()->SetInliningDepth(1);
...
TEST_F(DeoptimizeEliminationTest, RemoveSafePoint2)
{
    ...
    sp->SetVirtualRegister(0, VirtualRegister(0, VRegInfo::VRegType::VREG));
    sp->SetVirtualRegister(1, VirtualRegister(1, VRegInfo::VRegType::VREG));
...
TEST_F(DeoptimizeEliminationTest, RemoveObjectInputsSafePoint)
{
    ...
    GRAPH(graph_et)
    {
        ...
        BASIC_BLOCK(2, -1)
        {
            INST(4, Opcode::SafePoint).Inputs(0).SrcVregs({0});
            INST(5, Opcode::ReturnVoid).v0id();
        }
    }
