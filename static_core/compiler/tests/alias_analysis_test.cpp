...
{
    RuntimeInterface::FieldPtr field = reinterpret_cast<void *>(0xDEADBEEF);  // NOLINT(modernize-use-auto)
    GRAPH(GetGraph())
    {
        BASIC_BLOCK(2, 1)
        {
...
TEST_F(AliasAnalysisTest, LoadObjectStatic)
{
    GRAPH(GetGraph())
    {
        ...
        BASIC_BLOCK(2, -1)
        {
            ...
            INST(7, Opcode::LoadAndInitClass).ref().Inputs(10).TypeId(0U);
            INST(8, Opcode::LoadAndInitClass).ref().Inputs(10).TypeId(0U);
            INST(9, Opcode::LoadAndInitClass).ref().Inputs(10).TypeId(0U);
            INST(1, Opcode::LoadStatic).ref().Inputs(7).TypeId(349U);
            INST(2, Opcode::LoadObject).ref().Inputs(7).TypeId(349U).ObjectType(ObjectType::MEM_STATIC);
            INST(3, Opcode::LoadObject).ref().Inputs(8).TypeId(377U).ObjectType(ObjectType::MEM_STATIC);
            INST(4, Opcode::StoreStatic).ref().Inputs(8, 1).TypeId(377U);
            INST(5, Opcode::StoreObject).ref().Inputs(8, 1).TypeId(377U).ObjectType(ObjectType::MEM_STATIC);
            INST(6, Opcode::StoreObject).ref().Inputs(9, 2).TypeId(363U).ObjectType(ObjectType::MEM_STATIC);
            INST(25, Opcode::ReturnVoid).v0id();
        }
    }
    ...
    auto &alias = GetGraph()->GetAnalysis<AliasAnalysis>();
    ASSERT_EQ(alias.CheckInstAlias(&INS(1), &INS(2)), AliasType::MUST_ALIAS);
    ASSERT_EQ(alias.CheckInstAlias(&INS(4), &INS(5)), AliasType::MUST_ALIAS);
    ASSERT_EQ(alias.CheckInstAlias(&INS(3), &INS(4)), AliasType::MUST_ALIAS);
    ASSERT_EQ(alias.CheckInstAlias(&INS(2), &INS(3)), AliasType::NO_ALIAS);
    ASSERT_EQ(alias.CheckInstAlias(&INS(5), &INS(6)), AliasType::NO_ALIAS);
}
...
TEST_F(AliasAnalysisTest, DynamicMethods)
{
    ...
    GRAPH(graph)
    {
        ...
        BASIC_BLOCK(2, -1)
        {
            INST(10, Opcode::LoadObjectDynamic)
                .any()
                .Inputs(0, 1, 0)
                .SetAccessType(DynObjectAccessType::BY_INDEX)
                .SetAccessMode(DynObjectAccessMode::ARRAY);
            INST(11, Opcode::StoreObjectDynamic)
                .any()
                .Inputs(0, 1, 5, 0)
                .SetAccessType(DynObjectAccessType::BY_INDEX)
                .SetAccessMode(DynObjectAccessMode::ARRAY);
            INST(12, Opcode::StoreObjectDynamic)
                .any()
                .Inputs(0, 4, 10, 0)
                .SetAccessType(DynObjectAccessType::BY_INDEX)
                .SetAccessMode(DynObjectAccessMode::ARRAY);
            INST(13, Opcode::StoreObjectDynamic)
                .any()
                .Inputs(0, 5, 10, 0)
                .SetAccessType(DynObjectAccessType::BY_INDEX)
                .SetAccessMode(DynObjectAccessMode::ARRAY);

            INST(14, Opcode::LoadObjectDynamic)
                .any()
                .Inputs(0, 1, 0)
                .SetAccessType(DynObjectAccessType::BY_INDEX)
                .SetAccessMode(DynObjectAccessMode::DICTIONARY);

            INST(15, Opcode::LoadObjectDynamic)
                .any()
                .Inputs(2, 3, 0)
                .SetAccessType(DynObjectAccessType::BY_INDEX)
                .SetAccessMode(DynObjectAccessMode::DICTIONARY);
            INST(16, Opcode::StoreObjectDynamic)
                .any()
                .Inputs(2, 3, 14, 0)
                .SetAccessType(DynObjectAccessType::BY_NAME)
                .SetAccessMode(DynObjectAccessMode::DICTIONARY);
            INST(17, Opcode::LoadObjectDynamic)
                .any()
                .Inputs(2, 4, 0)
                .SetAccessType(DynObjectAccessType::BY_NAME)
                .SetAccessMode(DynObjectAccessMode::DICTIONARY);
            INST(18, Opcode::StoreObjectDynamic)
                .any()
                .Inputs(2, 5, 16, 0)
                .SetAccessType(DynObjectAccessType::BY_INDEX)
                .SetAccessMode(DynObjectAccessMode::DICTIONARY);
    ...
    ASSERT_EQ(alias.CheckInstAlias(&INS(10), &INS(11)), AliasType::MUST_ALIAS);
    ASSERT_EQ(alias.CheckInstAlias(&INS(10), &INS(12)), AliasType::MAY_ALIAS);
    ASSERT_EQ(alias.CheckInstAlias(&INS(12), &INS(13)), AliasType::MAY_ALIAS);

    ASSERT_EQ(alias.CheckInstAlias(&INS(10), &INS(14)), AliasType::NO_ALIAS);

    ASSERT_EQ(alias.CheckInstAlias(&INS(14), &INS(15)), AliasType::MAY_ALIAS);
    ASSERT_EQ(alias.CheckInstAlias(&INS(15), &INS(16)), AliasType::MAY_ALIAS);
    ASSERT_EQ(alias.CheckInstAlias(&INS(15), &INS(18)), AliasType::MAY_ALIAS);
    ASSERT_EQ(alias.CheckInstAlias(&INS(16), &INS(17)), AliasType::MAY_ALIAS);
}
