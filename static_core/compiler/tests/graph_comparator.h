...
#define CHECK_OR_RETURN(Opc, Getter) /* CC-OFFNXT(G.PRE.02) namespace member */                          \
    ...
    {
        CHECK_OR_RETURN(LoadArray, GetNeedReadBarrier)
        CHECK_OR_RETURN(LoadArrayPair, GetNeedReadBarrier)
        CHECK_OR_RETURN(StoreArray, GetNeedPreWriteBarrier)
        CHECK_OR_RETURN(StoreArray, GetNeedPostWriteBarrier)
        CHECK_OR_RETURN(StoreArrayPair, GetNeedPreWriteBarrier)
        CHECK_OR_RETURN(StoreArrayPair, GetNeedPostWriteBarrier)
        CHECK_OR_RETURN(LoadArrayI, GetNeedReadBarrier)
        CHECK_OR_RETURN(LoadArrayPairI, GetNeedReadBarrier)
        CHECK_OR_RETURN(StoreArrayI, GetNeedPreWriteBarrier)
        CHECK_OR_RETURN(StoreArrayI, GetNeedPostWriteBarrier)
        CHECK_OR_RETURN(StoreArrayPairI, GetNeedPreWriteBarrier)
        CHECK_OR_RETURN(StoreArrayPairI, GetNeedPostWriteBarrier)
        CHECK_OR_RETURN(LoadStatic, GetNeedReadBarrier)
        CHECK_OR_RETURN(StoreStatic, GetNeedPreWriteBarrier)
        CHECK_OR_RETURN(StoreStatic, GetNeedPostWriteBarrier)
        CHECK_OR_RETURN(LoadObject, GetNeedReadBarrier)
        CHECK_OR_RETURN(StoreObject, GetNeedPreWriteBarrier)
        CHECK_OR_RETURN(StoreObject, GetNeedPostWriteBarrier)
