...
TEST_F(LifeIntervalsTest, SplitAroundUses)
{
    // Unsplittable intervals
    {
        ...
        li.AppendRange({10, 11});
        li.AddUsePosition(10);
        li.Finalize();
    ...
    // Split after begin
    {
        ...
        li.Finalize();
        li.SplitAroundUses(GetAllocator());
        CheckSiblingSequence(&li, {{10, 11}, {11, 12}});
    }

    {
        LifeIntervals li(GetAllocator());
        li.AppendRange({10, 100});
        li.AddUsePosition(10);
        li.Finalize();
        li.SplitAroundUses(GetAllocator());
        CheckSiblingSequence(&li, {{10, 11}, {11, 100}});
    }

    {
        ...
        li.Finalize();
        li.SplitAroundUses(GetAllocator());
        CheckSiblingSequence(&li, {{10, 12}, {12, 100}});
    }
...

    {
        ...
        li.Finalize();
        li.SplitAroundUses(GetAllocator());
        CheckSiblingSequence(&li, {{10, 99}, {99, 100}});
    }

    {
        LifeIntervals li(GetAllocator());
        li.AppendRange({10, 100});
        li.AddUsePosition(99);
        li.Finalize();
        li.SplitAroundUses(GetAllocator());
        CheckSiblingSequence(&li, {{10, 98}, {98, 100}});
    }
    ...
    // Split after begin and before end
    {
        ...
        li.Finalize();
        li.SplitAroundUses(GetAllocator());
        CheckSiblingSequence(&li, {{10, 11}, {11, 99}, {99, 100}});
    }

    {
        ...
        li.Finalize();
        li.SplitAroundUses(GetAllocator());
        CheckSiblingSequence(&li, {{10, 12}, {12, 98}, {98, 100}});
    }

    // Multisplits
    {
        LifeIntervals li(GetAllocator());
        li.AppendRange({10, 16});
        li.AddUsePosition(10);
        li.AddUsePosition(12);
        li.AddUsePosition(14);
        li.AddUsePosition(16);
        li.Finalize();
        li.SplitAroundUses(GetAllocator());
        CheckSiblingSequence(&li, {{10, 11}, {11, 13}, {13, 15}, {15, 16}});
    }

    {
        ...
        li.AppendRange({10, 16});
        li.AddUsePosition(11);
        li.AddUsePosition(13);
        li.AddUsePosition(15);
        li.Finalize();
        li.SplitAroundUses(GetAllocator());
        CheckSiblingSequence(&li, {{10, 12}, {12, 14}, {14, 16}});
    }

    {
        LifeIntervals li(GetAllocator());
        li.AppendRange({10, 100});
        li.AddUsePosition(30);
        li.AddUsePosition(50);
        li.AddUsePosition(70);
        li.Finalize();
        li.SplitAroundUses(GetAllocator());
        CheckSiblingSequence(&li, {{10, 29}, {29, 31}, {31, 49}, {49, 51}, {51, 69}, {69, 71}, {71, 100}});
    }
}
