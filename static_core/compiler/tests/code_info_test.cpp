...
TEST_F(CodeInfoTest, SingleStackmap)
{
    ...
    std::array vregs = {VRegInfo(1, VRegInfo::Location::FP_REGISTER, VRegInfo::Type::INT64, VRegInfo::VRegType::VREG),
                        VRegInfo(2, VRegInfo::Location::SLOT, VRegInfo::Type::OBJECT, VRegInfo::VRegType::VREG),
                        VRegInfo(12, VRegInfo::Location::REGISTER, VRegInfo::Type::OBJECT, VRegInfo::VRegType::VREG)};
    if constexpr (!ArchTraits<RUNTIME_ARCH>::IS_64_BITS) {  // NOLINT
        vregs[1].SetValue((vregs[1].GetValue() << 1U) + 1 + regs_count);
    } else {  // NOLINT
    ...
    ASSERT_EQ(code_info.GetRootsStackMask(stack_map).Read(0, 3), 1U << 2U);
...
TEST_F(CodeInfoTest, MultipleStackmaps)
{
    ...
    std::array vregs = {
        VRegInfo(1, VRegInfo::Location::REGISTER, VRegInfo::Type::INT64, VRegInfo::VRegType::VREG),
        VRegInfo(2, VRegInfo::Location::SLOT, VRegInfo::Type::OBJECT, VRegInfo::VRegType::VREG),
        VRegInfo(3, VRegInfo::Location::SLOT, VRegInfo::Type::OBJECT, VRegInfo::VRegType::VREG),
        VRegInfo(10, VRegInfo::Location::FP_REGISTER, VRegInfo::Type::FLOAT64, VRegInfo::VRegType::VREG),
        VRegInfo(20, VRegInfo::Location::SLOT, VRegInfo::Type::BOOL, VRegInfo::VRegType::VREG),
        VRegInfo(30, VRegInfo::Location::REGISTER, VRegInfo::Type::OBJECT, VRegInfo::VRegType::VREG),
    };
    ArenaBitVector stack_roots(GetAllocator());
...
TEST_F(CodeInfoTest, Constants)
{
    ...
    builder.AddConstant(0, VRegInfo::Type::INT64, VRegInfo::VRegType::VREG);
    builder.AddConstant(0x1234567890abcdef, VRegInfo::Type::INT64, VRegInfo::VRegType::ACC);
    builder.AddConstant(0x12345678, VRegInfo::Type::INT32, VRegInfo::VRegType::VREG);
    builder.EndStackMap();
    builder.EndMethod();
