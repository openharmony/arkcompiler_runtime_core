...
inline constexpr size_t ChooseIrtocOptimizedFpRegmask()
{
    constexpr size_t DEFAULT_FP_REGMASK = 0x00000100;
    size_t regmask = DEFAULT_FP_REGMASK;
#include "libarkbase/generated/plugins_regmasks.inl"
    return regmask;
}
