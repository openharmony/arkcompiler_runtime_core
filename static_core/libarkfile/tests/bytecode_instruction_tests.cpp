...
TEST(BytecodeInstruction, Parse)
{
    ...
    // ID32
    {
        ...
        BytecodeInstruction inst(bytecode);
        EXPECT_EQ(static_cast<uint8_t>(inst.GetOpcode()), 0x00);
        EXPECT_EQ((inst.GetId<BytecodeInstruction::Format::ID32>()), BytecodeId(0xabcdeef1));
    }
    ...
    // V4_V4_ID16
    {
        ...
        EXPECT_EQ((inst.GetId<BytecodeInstruction::Format::V4_V4_ID16>()), BytecodeId(0xeef1));
    }
    ...
    // V8_ID16
    {
        ...
        EXPECT_EQ((inst.GetId<BytecodeInstruction::Format::V8_ID16>()), BytecodeId(0xeef1));
    }
    ...
    // V4_V4_V4_V4_ID16
    {
        ...
        EXPECT_EQ((inst.GetId<BytecodeInstruction::Format::V4_V4_V4_V4_ID16>()), BytecodeId(0xeef1));
    }
}
...
TEST(BytecodeInstructionSafe, Parse)
{
    ...
    {
        const uint8_t bytecode[] = {0x00, 0xa1, 0xff};
        BytecodeInstructionSafe inst(bytecode, &bytecode[0], &bytecode[sizeof(bytecode)]);
        EXPECT_EQ(static_cast<uint8_t>(inst.GetOpcode()), 0x00);
    ...
    // ID32
    {
        ...
        BytecodeInstructionSafe inst(bytecode, &bytecode[0], &bytecode[sizeof(bytecode)]);
        EXPECT_EQ(static_cast<uint8_t>(inst.GetOpcode()), 0x00);
        EXPECT_EQ((inst.GetId<BytecodeInstructionSafe::Format::ID32>()), BytecodeId(0xabcdeef1));
    }
    ...
    // V4_V4_ID16
    {
        ...
        EXPECT_EQ((inst.GetId<BytecodeInstructionSafe::Format::V4_V4_ID16>()), BytecodeId(0xeef1));
    }
    ...
    // V8_ID16
    {
        ...
        EXPECT_EQ((inst.GetId<BytecodeInstructionSafe::Format::V8_ID16>()), BytecodeId(0xeef1));
    }
    ...
    // V4_V4_V4_V4_ID16
    {
        ...
        EXPECT_EQ((inst.GetId<BytecodeInstructionSafe::Format::V4_V4_V4_V4_ID16>()), BytecodeId(0xeef1));
    }
    ...
    // ID32
    {
        ...
        EXPECT_EQ(static_cast<uint8_t>(inst.GetOpcode()), 0x00);
        EXPECT_TRUE(inst.IsValid());
        EXPECT_EQ((inst.GetId<BytecodeInstructionSafe::Format::ID32>()), BytecodeId(0xcdeef1));
        EXPECT_FALSE(inst.IsValid());
    }
    ...
    // V4_V4_ID16
    {
        ...
        EXPECT_EQ((inst.GetVReg<BytecodeInstructionSafe::Format::V4_V4_ID16, 1>()), 0x2);
        EXPECT_TRUE(inst.IsValid());
        EXPECT_EQ((inst.GetId<BytecodeInstructionSafe::Format::V4_V4_ID16>()), BytecodeId(0xf1));
        EXPECT_FALSE(inst.IsValid());
    }
    ...
    // V8_ID16
    {
        ...
        EXPECT_EQ((inst.GetVReg<BytecodeInstructionSafe::Format::V8_ID16, 0>()), 0x12);
        EXPECT_TRUE(inst.IsValid());
        EXPECT_EQ((inst.GetId<BytecodeInstructionSafe::Format::V8_ID16>()), BytecodeId(0x00));
        EXPECT_FALSE(inst.IsValid());
    }
    ...
    // V4_V4_V4_V4_ID16
    {
        ...
        EXPECT_EQ((inst.GetVReg<BytecodeInstructionSafe::Format::V4_V4_V4_V4_ID16, 0x3>()), 0x4);
        EXPECT_TRUE(inst.IsValid());
        EXPECT_EQ((inst.GetId<BytecodeInstructionSafe::Format::V4_V4_V4_V4_ID16>()), BytecodeId(0x0));
        EXPECT_FALSE(inst.IsValid());
    }
}
