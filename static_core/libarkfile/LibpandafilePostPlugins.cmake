...
set(FILE_ITEMS_GEN_INC ${PANDA_BINARY_ROOT}/libarkfile/include/file_items_gen.inc)
panda_gen_file(
    DATA ${GEN_PLUGIN_OPTIONS_YAML}
    TEMPLATE ${ARKFILE_ROOT}/templates/file_items_gen.inc.erb
    API ${PANDA_ROOT}/templates/plugin_options.rb
    EXTRA_DEPENDENCIES plugin_options_merge
    OUTPUTFILE ${FILE_ITEMS_GEN_INC}
)

set(SOURCE_LANG_ENUM_H ${PANDA_BINARY_ROOT}/libarkfile/include/source_lang_enum.h)
panda_gen_file(
    DATA ${GEN_PLUGIN_OPTIONS_YAML}
    TEMPLATE ${ARKFILE_ROOT}/templates/source_lang_enum.h.erb
    API ${PANDA_ROOT}/templates/plugin_options.rb
    EXTRA_DEPENDENCIES plugin_options_merge
