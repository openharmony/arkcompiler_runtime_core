...
if(NOT DEFINED PANDA_USE_64_BIT_POINTER)
    set(PANDA_USE_64_BIT_POINTER OFF)
endif()
if(PANDA_TARGET_64 AND (NOT PANDA_USE_64_BIT_POINTER))
...
message(STATUS "PANDA_USE_32_BIT_POINTER               = ${PANDA_USE_32_BIT_POINTER}")
message(STATUS "PANDA_USE_64_BIT_POINTER               = ${PANDA_USE_64_BIT_POINTER}")
