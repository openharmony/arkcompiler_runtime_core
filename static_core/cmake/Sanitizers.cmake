...
function(panda_add_sanitizers)
    ...
    get_target_property(target_is_imported ${ARG_TARGET} IMPORTED)
    ...
    if(ARG_SANITIZERS)
        ...
        set(SANITIZERS_LINK_FLAGS_LIST)
        foreach(sanitizer ${ARG_SANITIZERS})
            ...
            if(${sanitizer} STREQUAL "address")
                list(APPEND SANITIZERS_LINK_FLAGS_LIST "-lasan")
            elseif(${sanitizer} STREQUAL "undefined")
                list(APPEND SANITIZERS_LINK_FLAGS_LIST "-lubsan")
            else()
                list(APPEND SANITIZERS_LINK_FLAGS_LIST "-ltsan")
            endif()
        endforeach()
        ...
        string(REPLACE ";" " " SANITIZERS_LINK_FLAGS "${SANITIZERS_LINK_FLAGS_LIST}")
        set_target_properties(${ARG_TARGET} PROPERTIES LINK_FLAGS ${SANITIZERS_LINK_FLAGS})
