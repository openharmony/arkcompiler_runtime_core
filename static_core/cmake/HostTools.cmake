...
function(panda_configure_host_tools)
    ...
    set(HOST_TOOLS_CMAKE_ARGS
        ...
        -DPANDA_LLVMAOT=${PANDA_LLVMAOT}
        -DLLVMAOT_LLVM_PATH=${IRTOC_LLVM_PATH}
        ...
        -DIRTOC_INT_LLVM_INL_MODULE=${IRTOC_INT_LLVM_INL_MODULE}
        -DPANDA_LLVMAOT_IR_INLINING=${PANDA_LLVMAOT_IR_INLINING}
