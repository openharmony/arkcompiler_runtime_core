...
#include "runtime/mem/gc/cmc/heap/allocator/alloc_buffer_manager.h"
...
public:
    ...
    {
        allocBufferManager_->VisitAllocBuffers(visitor);
    }
    void AddHungryBuffer(AllocationBuffer &buffer)
    {
        allocBufferManager_->AddHungryBuffer(buffer);
    }
