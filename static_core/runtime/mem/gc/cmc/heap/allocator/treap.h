...
#ifndef COMMON_RUNTIME_COMMON_COMPONENTS_HEAP_ALLOCATOR_TREAP_H
#define COMMON_RUNTIME_COMMON_COMPONENTS_HEAP_ALLOCATOR_TREAP_H

#include <cstddef>
#include <cstdint>

#include "runtime/mem/gc/cmc/heap/allocator/local_deque.h"
...
public:
    ...
    void IncTotalCount(uint32_t cnt)
    {
        totalCount_ += cnt;
    }
    ...
    inline const TreapNode *RootNode() const
    {
        return root_;
    }
...
private:
    ...
    // move node n down in the tree to maintain the heap property
    void LowerNonZeroNode(TreapNode *&n) const
    {
        MaintainHeapPropertyForNonZeroNode(n);
    }
