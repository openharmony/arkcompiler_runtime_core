...
#ifndef COMMON_RUNTIME_COMMON_COMPONENTS_BASE_TIME_UTILS_H
#define COMMON_RUNTIME_COMMON_COMPONENTS_BASE_TIME_UTILS_H
...
PANDA_PUBLIC_API uint64_t NanoSeconds();
