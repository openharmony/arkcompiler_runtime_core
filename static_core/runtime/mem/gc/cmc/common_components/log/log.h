...
// CC-OFFNXT(G.PRE.02) code readability, standard log macro approach
#define LOGD_IF(cond) (UNLIKELY(cond)) && LOG_COMMON(DEBUG)
// CC-OFFNXT(G.PRE.02) code readability, standard log macro approach
#define LOGI_IF(cond) (UNLIKELY(cond)) && LOG_COMMON(INFO)
// CC-OFFNXT(G.PRE.02) code readability, standard log macro approach
#define LOGW_IF(cond) (UNLIKELY(cond)) && LOG_COMMON(WARN)
// CC-OFFNXT(G.PRE.02) code readability, standard log macro approach
#define LOGE_IF(cond) (UNLIKELY(cond)) && LOG_COMMON(ERROR)
// CC-OFFNXT(G.PRE.02) code readability, standard log macro approach
#define LOGF_IF(cond) (UNLIKELY(cond)) && LOG_COMMON(ERROR) << "Check failed: " << #cond && LOG_COMMON(FATAL)

// CC-OFFNXT(G.PRE.02) code readability, standard log macro approach
#define CHECKF(cond) (UNLIKELY(!(cond))) && LOG_COMMON(FATAL) << "Check failed: " << #cond
// CC-OFFNXT(G.PRE.02) code readability, standard log macro approach
