 ...
 */
#ifndef COMMON_RUNTIME_COMMON_COMPONENTS_HEAP_COLLECTOR_GC_DEBUGGER_H
#define COMMON_RUNTIME_COMMON_COMPONENTS_HEAP_COLLECTOR_GC_DEBUGGER_H
...
public:
    ...
    void InsertDerivedPtrRef(BasePtrType base, DerivedPtrType derived)
    {
        derivedPtrRef[base] = derived;
    }
...
public:
    ...
    {
        gcInfosForMarking.push_back(frameGCInfo);
    }
    void PushFrameInfoForMarking(const GCInfoNode &&frameGCInfo)
    {
        gcInfosForMarking.push_back(frameGCInfo);
    ...
    {
        gcInfosForFix.push_back(frameGCInfo);
    }
    void PushFrameInfoForFix(const GCInfoNodeForFix &&frameGCInfo)
    {
        gcInfosForFix.push_back(frameGCInfo);
