 ...
 */
#ifndef COMMON_RUNTIME_COMMON_COMPONENTS_HEAP_YOUNG_SPACE_H
#define COMMON_RUNTIME_COMMON_COMPONENTS_HEAP_YOUNG_SPACE_H
...
public:
    YoungSpace(RegionManager &regionManager)
    ...
    {
        ark::os::memory::LockHolder lock(lock_);
        DCHECK(region->IsThreadLocalRegion());
    ...
    RegionList &GetTlRegionList() noexcept
    {
        return tlRegionList_;
    }

    RegionList &GetRecentFullRegionList() noexcept
    {
        return recentFullRegionList_;
    }
