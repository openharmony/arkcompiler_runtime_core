...
public:
    ...
    {
        auto visitFunc = [&func](RegionDesc *region) { region->VisitRememberSet(func); };

        auto visitRecentFunc = [&func](RegionDesc *region) { region->VisitRememberSetBeforeMarking(func); };
