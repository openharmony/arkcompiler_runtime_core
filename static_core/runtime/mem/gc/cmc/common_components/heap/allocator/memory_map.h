...
public:
    ...
    static constexpr Option DEFAULT_OPTIONS = {"arkcommon_unnamed", nullptr, DEFAULT_MEM_FLAGS, DEFAULT_MEM_PROT,
                                               false};
    ...
    {
        return memCurrEndAddr_;
    }
    void *GetMappedEndAddr() const
    {
        return memMappedEndAddr_;
    }
