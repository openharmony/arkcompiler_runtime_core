...
#ifndef COMMON_RUNTIME_COMMON_COMPONENTS_HEAP_ALLOCATOR_ALLOC_BUFFER_MANAGER
#define COMMON_RUNTIME_COMMON_COMPONENTS_HEAP_ALLOCATOR_ALLOC_BUFFER_MANAGER
...
public:
    using AllocBuffersSet =
        std::unordered_set<AllocationBuffer *, std::hash<AllocationBuffer *>, std::equal_to<AllocationBuffer *>,
                           StdContainerAllocator<AllocationBuffer *, ALLOCATOR>>;
    ...
    {
        ark::os::memory::LockHolder lg(hungryBuffersLock_);
