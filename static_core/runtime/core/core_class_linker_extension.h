 ...
 */
#ifndef PANDA_RUNTIME_CORE_CORE_CLASS_LINKER_EXTENSION_H
#define PANDA_RUNTIME_CORE_CORE_CLASS_LINKER_EXTENSION_H
...
#endif  // PANDA_RUNTIME_CORE_CORE_CLASS_LINKER_EXTENSION_H