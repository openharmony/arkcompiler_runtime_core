...
TEST_F(StringTest, SlicedStringGC)
{
    ...
    const ark::mem::SlicedString *slicedString = resultHandle->ToSlicedString();
    String *parentString = String::Cast(slicedString->GetParent<ark::mem::BaseString *>(std::move(firstReadBarrier)));
    ...
    parentString = String::Cast(slicedString->GetParent<ark::mem::BaseString *>(std::move(secondReadBarrier)));
    ASSERT_EQ(parentString->IsLineString(), true);
    ASSERT_EQ(slicedString->IsSlicedString(), true);
    ASSERT_EQ(String::StringsAreEqual(parentString, stringHandle.GetPtr()), true);
    ASSERT_EQ(String::StringsAreEqual(resultHandle.GetPtr(), expectedHandle.GetPtr()), true);
...
TEST_F(StringTest, TreeStringGC)
{
    ...
    ark::mem::TreeString *tree = resultHandle->ToTreeString();
    String *left = String::Cast(tree->GetLeftSubString<ark::mem::BaseString *>(std::move(leftFirstReadBarrier)));
    String *right = String::Cast(tree->GetRightSubString<ark::mem::BaseString *>(std::move(rightFirstReadBarrier)));
    ...
    left = String::Cast(tree->GetLeftSubString<ark::mem::BaseString *>(std::move(leftSecondReadBarrier)));
    right = String::Cast(tree->GetRightSubString<ark::mem::BaseString *>(std::move(rightSecondReadBarrier)));
    ASSERT_EQ(left->IsLineString(), true);
    ASSERT_EQ(right->IsLineString(), true);
    ASSERT_EQ(String::StringsAreEqual(left, sub1Handle.GetPtr()), true);
    ASSERT_EQ(String::StringsAreEqual(right, sub2Handle.GetPtr()), true);
...
TEST_F(StringOOMTest, AllocSlicedStringObjectWithOOM)
{
    ...
    String *src = mem::ObjectAllocator::AllocString(ark::mem::SlicedString::SIZE);
    ASSERT_NE(src, nullptr);

    coretypes::String *objString;
    do {
        objString = mem::ObjectAllocator::AllocString(ark::mem::SlicedString::SIZE);
...
TEST_F(StringOOMTest, AllocTreeStringObjectWithOOM)
{
    ...
    String *left = mem::ObjectAllocator::AllocString(ark::mem::TreeString::SIZE);
    String *right = mem::ObjectAllocator::AllocString(ark::mem::TreeString::SIZE);
    ASSERT_NE(left, nullptr);
    ASSERT_NE(right, nullptr);

    coretypes::String *objString;
    do {
        objString = mem::ObjectAllocator::AllocString(ark::mem::TreeString::SIZE);
    } while (objString != nullptr);
