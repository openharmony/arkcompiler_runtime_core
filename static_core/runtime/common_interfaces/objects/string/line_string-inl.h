...
template <typename Allocator, objects_traits::EnableIfIsAllocate<Allocator, BaseObject *>>
                                       ...
                                       bool canBeCompress)
{
    ...
    DCHECK(canBeCompress == LineString::CanBeCompressed(string) && "Bad input canBeCompress!");
    return string;
}
                                                          ...
                                                          uint32_t utf8Len)
{
    ...
    DCHECK(LineString::CanBeCompressed(subString) && "String cannot be compressed!");
    return subString;
}
