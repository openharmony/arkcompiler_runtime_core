...
public:
    ...
    NO_MOVE_SEMANTIC(LineString);
    NO_COPY_SEMANTIC(LineString);
     ...
     */
    template <typename Allocator, objects_traits::EnableIfIsAllocate<Allocator, BaseObject *> = 0>
...
{
    DCHECK(IsUtf8() && "BaseString: Read data as utf8 for utf16 string");
