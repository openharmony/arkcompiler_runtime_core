...
#ifndef COMMON_RUNTIME_COMMON_INTERFACES_OBJECTS_STRING_TREE_STRING_H
#define COMMON_RUNTIME_COMMON_INTERFACES_OBJECTS_STRING_TREE_STRING_H
...
public:
    ...
    NO_MOVE_SEMANTIC(TreeString);
    NO_COPY_SEMANTIC(TreeString);
    ...
    template <typename Allocator, typename WriteBarrier,
              objects_traits::EnableIfIsAllocate<Allocator, BaseObject *> = 0,
              objects_traits::EnableIfIsWriteBarrier<WriteBarrier> = 0>
