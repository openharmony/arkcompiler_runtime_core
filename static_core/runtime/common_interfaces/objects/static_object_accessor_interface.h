...
public:
    ...
    virtual bool HasProperty(ark::common_vm::Mutator *mutator, const BaseObject *obj, const char *name) = 0;

    // GetProperty is used to get the value of a property from a static object with the given name.
    virtual BoxedValue GetProperty(ark::common_vm::Mutator *mutator, const BaseObject *obj, const char *name) = 0;

    // SetProperty is used to set the value of a property in a static object with the given name.
    virtual bool SetProperty(ark::common_vm::Mutator *mutator, BaseObject *obj, const char *name, BoxedValue value) = 0;
    ...
    virtual bool HasElementByIdx(ark::common_vm::Mutator *mutator, const BaseObject *obj, const uint32_t index) = 0;

    // GetElementByIdx is used to get the value of an element from a static object with the given index.
    virtual BoxedValue GetElementByIdx(ark::common_vm::Mutator *mutator, const BaseObject *obj,
                                       const uint32_t index) = 0;

    // SetElementByIdx is used to set the value of an element in a static object with the given index.
    virtual bool SetElementByIdx(ark::common_vm::Mutator *mutator, BaseObject *obj, uint32_t index,
                                 BaseObject *const value) = 0;
};
}  // namespace ark::mem
