...
public:
    ...
    {
        return CFrameLayout::IsResumedFlag::Get(*GetPtr<SlotType>(CFrameLayout::FlagsSlot::Start()));
    }

    void SetIsResumed(bool v)
    {
        CFrameLayout::IsResumedFlag::Set(v, GetPtr<SlotType>(CFrameLayout::FlagsSlot::Start()));
    }
