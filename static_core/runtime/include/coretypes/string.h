...
public:
    static constexpr uint32_t STRING_LENGTH_SHIFT = panda::BaseString::LengthBits::START_BIT;
    ...
    PANDA_PUBLIC_API static bool StringsAreEqualUtf16(String *str1, const uint16_t *utf16Data, uint32_t utf16DataLength)
    {
        ...
        return panda::BaseString::StringsAreEqualUtf16(readBarrier, str1->ToString(), utf16Data, utf16DataLength);
    }
    ...
    static uint32_t ComputeHashcodeMutf8(const uint8_t *mutf8Data, [[maybe_unused]] uint32_t utf16Length,
                                         bool canBeCompressed)
    {
        return panda::BaseString::ComputeHashcodeUtf8(mutf8Data, utf::Mutf8Size(mutf8Data), canBeCompressed);
    }
    ...
    {
        return panda::BaseString::ComputeHashcodeUtf16(utf16Data, length);
    }
    ...
    static String *Cast(panda::BaseString *str)
    {
    ...
    panda::BaseString *ToString()
    {
        return panda::BaseString::Cast(reinterpret_cast<panda::BaseObject *>(this));
    }

    const panda::BaseString *ToStringConst() const
    {
        return panda::BaseString::ConstCast(reinterpret_cast<const panda::BaseObject *>(this));
    }

    static constexpr uint32_t GetLengthOffset()
    {
        return panda::BaseString::LENGTH_AND_FLAGS_OFFSET;
    }

    static constexpr uint32_t GetHashcodeOffset()
    {
        return panda::BaseString::RAW_HASHCODE_OFFSET;
    }

    static constexpr uint32_t GetDataOffset()
    {
        return panda::LineString::DATA_OFFSET;
    }
    ...
    {
        return panda::BaseString::IsASCIICharacter(data);
    }
    ...
    panda::LineString *ToLineString()
    {
        ASSERT(IsLineString());
        return panda::LineString::Cast(ToString());
    }

    const panda::SlicedString *ToSlicedString() const
    {
        ASSERT(IsSlicedString());
        return panda::SlicedString::ConstCast(ToStringConst());
    }

    panda::TreeString *ToTreeString()
    {
        ASSERT(IsTreeString());
        return panda::TreeString::Cast(ToString());
    }
    ...
    {
        if (IsLineString()) {
            return panda::LineString::ObjectSize(ToStringConst());
        }
        if (IsSlicedString()) {
            return panda::SlicedString::SIZE;
        }
        if (IsTreeString()) {
            return panda::TreeString::SIZE;
        }
        UNREACHABLE();
    }
    ...
    {
        auto readBarrier = [](void *obj, size_t offset) {
            return reinterpret_cast<panda::BaseString *>(ObjectAccessor::GetObject(obj, offset));
        };
...
public:
    ...
    std::u16string ToU16String(uint32_t len = 0)
    {
        ...
        if (IsUtf16()) {
            ...
            result = panda::Utf16ToU16String(data, length);
        } else {
            const uint8_t *data = this->GetDataUtf8();
            result = panda::Utf8ToU16String(data, length);
        }
        return result;
    }
