...
{
    (void)venv;
    EtsMethod *etsMethod = ToInternalMethod(methodArgs.method);
...
static ANIArg::AniMethodArgs GetVArgsByVVAArgs(ani_method method, va_list vvaArgs)
{
    // NOTE: Add method validation
    ASSERT(method != nullptr);

    ANIArg::AniMethodArgs methodArgs {method, nullptr, {}, true};
    auto &args = methodArgs.argsStorage;
    EtsMethod *etsMethod = ToInternalMethod(method);
    // NOTE: Check correcting number of args for ani_method/ani_static_method/ani_function
...
// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_New(VEnv *venv, VClass *vclass, ani_method ctor, VObject **vresult, ...)
{
    // NOTE: Validate ctor method before usage

    va_list vvaArgs;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(vvaArgs, vresult);
    ANIArg::AniMethodArgs methodVArgs = GetVArgsByVVAArgs(ctor, vvaArgs);
    va_end(vvaArgs);
    ...
    VERIFY_ANI_ARGS(
        ...
        ANIArg::MakeForMethod(ctor, "ctor", true),
...
// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_New_A(VEnv *venv, VClass *vclass, ani_method ctor, VObject **vresult,
                                              const ani_value *vargs)
{
    ANIArg::AniMethodArgs methodArgs {ctor, vargs, {}, false};
    // clang-format off
    VERIFY_ANI_ARGS(
        ANIArg::MakeForEnv(venv, "env"),
        ANIArg::MakeForClass(vclass, "cls"),
...
// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_New_V(VEnv *venv, VClass *vclass, ani_method ctor, VObject **vresult,
                                              va_list vvaArgs)
{
    ANIArg::AniMethodArgs methodArgs = GetVArgsByVVAArgs(ctor, vvaArgs);
    // clang-format off
    VERIFY_ANI_ARGS(
        ANIArg::MakeForEnv(venv, "env"),
        ANIArg::MakeForClass(vclass, "cls"),
...
// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_New_Boolean(VEnv *venv, ani_size length, ani_array_boolean *result)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_New_Boolean(venv->GetEnv(), length, result);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_New_Char(VEnv *venv, ani_size length, ani_array_char *result)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_New_Char(venv->GetEnv(), length, result);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_New_Byte(VEnv *venv, ani_size length, ani_array_byte *result)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_New_Byte(venv->GetEnv(), length, result);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_New_Short(VEnv *venv, ani_size length, ani_array_short *result)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_New_Short(venv->GetEnv(), length, result);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_New_Int(VEnv *venv, ani_size length, ani_array_int *result)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_New_Int(venv->GetEnv(), length, result);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_New_Long(VEnv *venv, ani_size length, ani_array_long *result)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_New_Long(venv->GetEnv(), length, result);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_New_Float(VEnv *venv, ani_size length, ani_array_float *result)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_New_Float(venv->GetEnv(), length, result);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_New_Double(VEnv *venv, ani_size length, ani_array_double *result)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_New_Double(venv->GetEnv(), length, result);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_GetRegion_Boolean(VEnv *venv, ani_array_boolean array, ani_size offset,
                                                         ani_size length, ani_boolean *nativeBuffer)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_GetRegion_Boolean(venv->GetEnv(), array, offset, length, nativeBuffer);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_GetRegion_Char(VEnv *venv, ani_array_char array, ani_size offset,
                                                      ani_size length, ani_char *nativeBuffer)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_GetRegion_Char(venv->GetEnv(), array, offset, length, nativeBuffer);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_GetRegion_Byte(VEnv *venv, ani_array_byte array, ani_size offset,
                                                      ani_size length, ani_byte *nativeBuffer)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_GetRegion_Byte(venv->GetEnv(), array, offset, length, nativeBuffer);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_GetRegion_Short(VEnv *venv, ani_array_short array, ani_size offset,
                                                       ani_size length, ani_short *nativeBuffer)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_GetRegion_Short(venv->GetEnv(), array, offset, length, nativeBuffer);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_GetRegion_Int(VEnv *venv, ani_array_int array, ani_size offset, ani_size length,
                                                     ani_int *nativeBuffer)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_GetRegion_Int(venv->GetEnv(), array, offset, length, nativeBuffer);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_GetRegion_Long(VEnv *venv, ani_array_long array, ani_size offset,
                                                      ani_size length, ani_long *nativeBuffer)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_GetRegion_Long(venv->GetEnv(), array, offset, length, nativeBuffer);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_GetRegion_Float(VEnv *venv, ani_array_float array, ani_size offset,
                                                       ani_size length, ani_float *nativeBuffer)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_GetRegion_Float(venv->GetEnv(), array, offset, length, nativeBuffer);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_GetRegion_Double(VEnv *venv, ani_array_double array, ani_size offset,
                                                        ani_size length, ani_double *nativeBuffer)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_GetRegion_Double(venv->GetEnv(), array, offset, length, nativeBuffer);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_SetRegion_Boolean(VEnv *venv, ani_array_boolean array, ani_size offset,
                                                         ani_size length, const ani_boolean *nativeBuffer)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_SetRegion_Boolean(venv->GetEnv(), array, offset, length, nativeBuffer);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_SetRegion_Char(VEnv *venv, ani_array_char array, ani_size offset,
                                                      ani_size length, const ani_char *nativeBuffer)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_SetRegion_Char(venv->GetEnv(), array, offset, length, nativeBuffer);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_SetRegion_Byte(VEnv *venv, ani_array_byte array, ani_size offset,
                                                      ani_size length, const ani_byte *nativeBuffer)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_SetRegion_Byte(venv->GetEnv(), array, offset, length, nativeBuffer);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_SetRegion_Short(VEnv *venv, ani_array_short array, ani_size offset,
                                                       ani_size length, const ani_short *nativeBuffer)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_SetRegion_Short(venv->GetEnv(), array, offset, length, nativeBuffer);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_SetRegion_Int(VEnv *venv, ani_array_int array, ani_size offset, ani_size length,
                                                     const ani_int *nativeBuffer)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_SetRegion_Int(venv->GetEnv(), array, offset, length, nativeBuffer);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_SetRegion_Long(VEnv *venv, ani_array_long array, ani_size offset,
                                                      ani_size length, const ani_long *nativeBuffer)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_SetRegion_Long(venv->GetEnv(), array, offset, length, nativeBuffer);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_SetRegion_Float(VEnv *venv, ani_array_float array, ani_size offset,
                                                       ani_size length, const ani_float *nativeBuffer)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_SetRegion_Float(venv->GetEnv(), array, offset, length, nativeBuffer);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_SetRegion_Double(VEnv *venv, ani_array_double array, ani_size offset,
                                                        ani_size length, const ani_double *nativeBuffer)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_SetRegion_Double(venv->GetEnv(), array, offset, length, nativeBuffer);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_New_Ref(VEnv *venv, ani_type type, ani_size length, ani_ref initialElement,
                                               ani_array_ref *result)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_New_Ref(venv->GetEnv(), type, length, initialElement, result);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_Set_Ref(VEnv *venv, ani_array_ref array, ani_size index, ani_ref ref)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_Set_Ref(venv->GetEnv(), array, index, ref);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Array_Get_Ref(VEnv *venv, ani_array_ref array, ani_size index, ani_ref *result)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Array_Get_Ref(venv->GetEnv(), array, index, result);
}
...
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_FindMethod(venv->GetEnv(), vclass->GetRef(), name, signature, result);
}
...
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_FindStaticMethod(venv->GetEnv(), vclass->GetRef(), name, signature, result);
}
...
// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Boolean(VEnv *venv, ani_class cls, ani_static_method method,
                                                                ani_boolean *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status =
        GetInteractionAPI(venv)->Class_CallStaticMethod_Boolean_V(venv->GetEnv(), cls, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Boolean_A(VEnv *venv, ani_class cls, ani_static_method method,
                                                                  ani_boolean *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Boolean_A(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Boolean_V(VEnv *venv, ani_class cls, ani_static_method method,
                                                                  ani_boolean *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Boolean_V(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Char(VEnv *venv, ani_class cls, ani_static_method method,
                                                             ani_char *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status =
        GetInteractionAPI(venv)->Class_CallStaticMethod_Char_V(venv->GetEnv(), cls, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Char_A(VEnv *venv, ani_class cls, ani_static_method method,
                                                               ani_char *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Char_A(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Char_V(VEnv *venv, ani_class cls, ani_static_method method,
                                                               ani_char *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Char_V(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Byte(VEnv *venv, ani_class cls, ani_static_method method,
                                                             ani_byte *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status =
        GetInteractionAPI(venv)->Class_CallStaticMethod_Byte_V(venv->GetEnv(), cls, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Byte_A(VEnv *venv, ani_class cls, ani_static_method method,
                                                               ani_byte *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Byte_A(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Byte_V(VEnv *venv, ani_class cls, ani_static_method method,
                                                               ani_byte *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Byte_V(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Short(VEnv *venv, ani_class cls, ani_static_method method,
                                                              ani_short *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status =
        GetInteractionAPI(venv)->Class_CallStaticMethod_Short_V(venv->GetEnv(), cls, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Short_A(VEnv *venv, ani_class cls, ani_static_method method,
                                                                ani_short *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Short_A(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Short_V(VEnv *venv, ani_class cls, ani_static_method method,
                                                                ani_short *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Short_V(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Int(VEnv *venv, ani_class cls, ani_static_method method,
                                                            ani_int *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status =
        GetInteractionAPI(venv)->Class_CallStaticMethod_Int_V(venv->GetEnv(), cls, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Int_A(VEnv *venv, ani_class cls, ani_static_method method,
                                                              ani_int *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Int_A(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Int_V(VEnv *venv, ani_class cls, ani_static_method method,
                                                              ani_int *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Int_V(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Long(VEnv *venv, ani_class cls, ani_static_method method,
                                                             ani_long *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status =
        GetInteractionAPI(venv)->Class_CallStaticMethod_Long_V(venv->GetEnv(), cls, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Long_A(VEnv *venv, ani_class cls, ani_static_method method,
                                                               ani_long *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Long_A(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Long_V(VEnv *venv, ani_class cls, ani_static_method method,
                                                               ani_long *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Long_V(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Float(VEnv *venv, ani_class cls, ani_static_method method,
                                                              ani_float *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status =
        GetInteractionAPI(venv)->Class_CallStaticMethod_Float_V(venv->GetEnv(), cls, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Float_A(VEnv *venv, ani_class cls, ani_static_method method,
                                                                ani_float *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Float_A(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Float_V(VEnv *venv, ani_class cls, ani_static_method method,
                                                                ani_float *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Float_V(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Double(VEnv *venv, ani_class cls, ani_static_method method,
                                                               ani_double *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status =
        GetInteractionAPI(venv)->Class_CallStaticMethod_Double_V(venv->GetEnv(), cls, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Double_A(VEnv *venv, ani_class cls, ani_static_method method,
                                                                 ani_double *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Double_A(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Double_V(VEnv *venv, ani_class cls, ani_static_method method,
                                                                 ani_double *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Double_V(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Ref(VEnv *venv, ani_class cls, ani_static_method method,
                                                            ani_ref *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status =
        GetInteractionAPI(venv)->Class_CallStaticMethod_Ref_V(venv->GetEnv(), cls, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Ref_A(VEnv *venv, ani_class cls, ani_static_method method,
                                                              ani_ref *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Ref_A(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Ref_V(VEnv *venv, ani_class cls, ani_static_method method,
                                                              ani_ref *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Ref_V(venv->GetEnv(), cls, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Void(VEnv *venv, ani_class cls, ani_static_method method, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, method);
    ani_status status = GetInteractionAPI(venv)->Class_CallStaticMethod_Void_V(venv->GetEnv(), cls, method, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Void_A(VEnv *venv, ani_class cls, ani_static_method method,
                                                               const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Void_A(venv->GetEnv(), cls, method, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Class_CallStaticMethod_Void_V(VEnv *venv, ani_class cls, ani_static_method method,
                                                               va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Class_CallStaticMethod_Void_V(venv->GetEnv(), cls, method, args);
}
...
// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Boolean(VEnv *venv, ani_object object, ani_method method,
                                                           ani_boolean *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status =
        GetInteractionAPI(venv)->Object_CallMethod_Boolean_V(venv->GetEnv(), object, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Boolean_A(VEnv *venv, ani_object object, ani_method method,
                                                             ani_boolean *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Boolean_A(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Boolean_V(VEnv *venv, ani_object object, ani_method method,
                                                             ani_boolean *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Boolean_V(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Char(VEnv *venv, ani_object object, ani_method method,
                                                        ani_char *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status = GetInteractionAPI(venv)->Object_CallMethod_Char_V(venv->GetEnv(), object, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Char_A(VEnv *venv, ani_object object, ani_method method,
                                                          ani_char *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Char_A(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Char_V(VEnv *venv, ani_object object, ani_method method,
                                                          ani_char *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Char_V(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Byte(VEnv *venv, ani_object object, ani_method method,
                                                        ani_byte *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status = GetInteractionAPI(venv)->Object_CallMethod_Byte_V(venv->GetEnv(), object, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Byte_A(VEnv *venv, ani_object object, ani_method method,
                                                          ani_byte *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Byte_A(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Byte_V(VEnv *venv, ani_object object, ani_method method,
                                                          ani_byte *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Byte_V(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Short(VEnv *venv, ani_object object, ani_method method,
                                                         ani_short *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status =
        GetInteractionAPI(venv)->Object_CallMethod_Short_V(venv->GetEnv(), object, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Short_A(VEnv *venv, ani_object object, ani_method method,
                                                           ani_short *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Short_A(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Short_V(VEnv *venv, ani_object object, ani_method method,
                                                           ani_short *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Short_V(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Int(VEnv *venv, ani_object object, ani_method method,
                                                       ani_int *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status = GetInteractionAPI(venv)->Object_CallMethod_Int_V(venv->GetEnv(), object, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Int_A(VEnv *venv, ani_object object, ani_method method,
                                                         ani_int *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Int_A(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Int_V(VEnv *venv, ani_object object, ani_method method,
                                                         ani_int *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Int_V(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Long(VEnv *venv, ani_object object, ani_method method,
                                                        ani_long *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status = GetInteractionAPI(venv)->Object_CallMethod_Long_V(venv->GetEnv(), object, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Long_A(VEnv *venv, ani_object object, ani_method method,
                                                          ani_long *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Long_A(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Long_V(VEnv *venv, ani_object object, ani_method method,
                                                          ani_long *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Long_V(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Float(VEnv *venv, ani_object object, ani_method method,
                                                         ani_float *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status =
        GetInteractionAPI(venv)->Object_CallMethod_Float_V(venv->GetEnv(), object, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Float_A(VEnv *venv, ani_object object, ani_method method,
                                                           ani_float *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Float_A(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Float_V(VEnv *venv, ani_object object, ani_method method,
                                                           ani_float *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Float_V(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Double(VEnv *venv, ani_object object, ani_method method,
                                                          ani_double *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status =
        GetInteractionAPI(venv)->Object_CallMethod_Double_V(venv->GetEnv(), object, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Double_A(VEnv *venv, ani_object object, ani_method method,
                                                            ani_double *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Double_A(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Double_V(VEnv *venv, ani_object object, ani_method method,
                                                            ani_double *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Double_V(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Ref(VEnv *venv, ani_object object, ani_method method,
                                                       ani_ref *result, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, result);
    ani_status status = GetInteractionAPI(venv)->Object_CallMethod_Ref_V(venv->GetEnv(), object, method, result, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Ref_A(VEnv *venv, ani_object object, ani_method method,
                                                         ani_ref *result, const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Ref_A(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Ref_V(VEnv *venv, ani_object object, ani_method method,
                                                         ani_ref *result, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Ref_V(venv->GetEnv(), object, method, result, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Void(VEnv *venv, ani_object object, ani_method method, ...)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    va_list args;  // NOLINT(cppcoreguidelines-pro-type-vararg)
    va_start(args, method);
    ani_status status = GetInteractionAPI(venv)->Object_CallMethod_Void_V(venv->GetEnv(), object, method, args);
    va_end(args);
    return status;
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Void_A(VEnv *venv, ani_object object, ani_method method,
                                                          const ani_value *args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Void_A(venv->GetEnv(), object, method, args);
}

// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethod_Void_V(VEnv *venv, ani_object object, ani_method method,
                                                          va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethod_Void_V(venv->GetEnv(), object, method, args);
}
...
// NOLINTNEXTLINE(readability-identifier-naming)
NO_UB_SANITIZE static ani_status Object_CallMethodByName_Void_V(VEnv *venv, ani_object object, const char *name,
                                                                const char *signature, va_list args)
{
    VERIFY_ANI_ARGS(ANIArg::MakeForEnv(venv, "env"), /* NOTE: Add checkers */);
    return GetInteractionAPI(venv)->Object_CallMethodByName_Void_V(venv->GetEnv(), object, name, signature, args);
}
...
const __ani_interaction_api VERIFY_INTERACTION_API = {
    ...
    VERIFY_ANI_CAST_API(Array_New_Boolean),
    VERIFY_ANI_CAST_API(Array_New_Char),
    VERIFY_ANI_CAST_API(Array_New_Byte),
    VERIFY_ANI_CAST_API(Array_New_Short),
    VERIFY_ANI_CAST_API(Array_New_Int),
    VERIFY_ANI_CAST_API(Array_New_Long),
    VERIFY_ANI_CAST_API(Array_New_Float),
    VERIFY_ANI_CAST_API(Array_New_Double),
    VERIFY_ANI_CAST_API(Array_GetRegion_Boolean),
    VERIFY_ANI_CAST_API(Array_GetRegion_Char),
    VERIFY_ANI_CAST_API(Array_GetRegion_Byte),
    VERIFY_ANI_CAST_API(Array_GetRegion_Short),
    VERIFY_ANI_CAST_API(Array_GetRegion_Int),
    VERIFY_ANI_CAST_API(Array_GetRegion_Long),
    VERIFY_ANI_CAST_API(Array_GetRegion_Float),
    VERIFY_ANI_CAST_API(Array_GetRegion_Double),
    VERIFY_ANI_CAST_API(Array_SetRegion_Boolean),
    VERIFY_ANI_CAST_API(Array_SetRegion_Char),
    VERIFY_ANI_CAST_API(Array_SetRegion_Byte),
    VERIFY_ANI_CAST_API(Array_SetRegion_Short),
    VERIFY_ANI_CAST_API(Array_SetRegion_Int),
    VERIFY_ANI_CAST_API(Array_SetRegion_Long),
    VERIFY_ANI_CAST_API(Array_SetRegion_Float),
    VERIFY_ANI_CAST_API(Array_SetRegion_Double),
    VERIFY_ANI_CAST_API(Array_New_Ref),
    VERIFY_ANI_CAST_API(Array_Set_Ref),
    VERIFY_ANI_CAST_API(Array_Get_Ref),
