...
public:
    ...
    bool IsMethodStringBuilderConcatStrings(MethodPtr method) const override;
    ...
    MethodPtr GetMethodStringBuilderToString() const override;
    MethodPtr GetMethodStringBuilderConcatStrings() const override;
    bool IsClassString(ClassPtr klass) const override;
    bool IsClassConsole(ClassPtr klass) const override;
    MethodPtr GetMethodStringLength() const override;
    MethodPtr GetMethodStringGetLength() const override;
    MethodPtr GetMethodStringIsEmpty() const override;
    MethodPtr GetMethodStringSubstringInt() const override;
    MethodPtr GetMethodStringSubstringIntInt() const override;
    MethodPtr GetMethodStringSubstr() const override;
    MethodPtr GetMethodStringConcat() const override;
    MethodPtr GetMethodStringConcatString2() const override;
    MethodPtr GetMethodStringConcatString3() const override;
    MethodPtr GetMethodStringConcatString4() const override;
    MethodPtr GetMethodStringValueOf() const override;
    MethodPtr GetMethodStringToString() const override;
    MethodPtr GetMethodStringCreateHTMLString() const override;
    MethodPtr GetMethodStringBig() const override;
    MethodPtr GetMethodStringSmall() const override;
    MethodPtr GetMethodStringBlink() const override;
    MethodPtr GetMethodStringBold() const override;
    MethodPtr GetMethodStringItalics() const override;
    MethodPtr GetMethodStringStrike() const override;
    MethodPtr GetMethodStringSub() const override;
    MethodPtr GetMethodStringSup() const override;
    MethodPtr GetMethodStringFixed() const override;
    MethodPtr GetMethodStringFontColor() const override;
    MethodPtr GetMethodStringFontSizeInt() const override;
    MethodPtr GetMethodStringFontSizeString() const override;
    MethodPtr GetMethodStringLink() const override;
    MethodPtr GetMethodStringSlice() const override;
    MethodPtr GetMethodStringIsCompressed() const override;
