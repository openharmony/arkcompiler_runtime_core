...
#ifndef PANDA_PLUGINS_ETS_RUNTIME_INTEROP_JS_ETS_PROXY_WRAPPERS_CACHE_H
#define PANDA_PLUGINS_ETS_RUNTIME_INTEROP_JS_ETS_PROXY_WRAPPERS_CACHE_H
...
#endif  // !PANDA_PLUGINS_ETS_RUNTIME_INTEROP_JS_ETS_PROXY_WRAPPERS_CACHE_H
