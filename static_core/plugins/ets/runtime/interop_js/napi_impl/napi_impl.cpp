...
napi_status __attribute__((weak))  // CC-OFF(G.FMT.10) project code style
napi_get_value_string_utf8_hybrid([[maybe_unused]] napi_env env, [[maybe_unused]] napi_value value,
                                  [[maybe_unused]] void *string_object)
{
    INTEROP_LOG(FATAL) << "ETS_INTEROP_GTEST_PLUGIN: " << __func__
                       << " is implemented in later versions of OHOS, please update." << std::endl;
    return napi_ok;
...
napi_status __attribute__((weak))  // CC-OFF(G.FMT.10) project code style
napi_is_undefined([[maybe_unused]] napi_env env, [[maybe_unused]] napi_value js_object, [[maybe_unused]] bool *result)
{
    INTEROP_LOG(FATAL) << "ETS_INTEROP_GTEST_PLUGIN: " << __func__
                       << " is implemented in later versions of OHOS, please update." << std::endl;
    return napi_ok;
...
napi_status __attribute__((weak))  // CC-OFF(G.FMT.10) project code style
napi_is_null([[maybe_unused]] napi_env env, [[maybe_unused]] napi_value js_object, [[maybe_unused]] bool *result)
{
    INTEROP_LOG(FATAL) << "ETS_INTEROP_GTEST_PLUGIN: " << __func__
                       << " is implemented in later versions of OHOS, please update." << std::endl;
    return napi_ok;
...
napi_status __attribute__((weak))  // CC-OFF(G.FMT.10) project code style
napi_unwrap_hybrid_s([[maybe_unused]] napi_env env, [[maybe_unused]] napi_value js_object,
                     [[maybe_unused]] const napi_type_tag *tag, [[maybe_unused]] void **result)
{
    INTEROP_LOG(FATAL) << "ETS_INTEROP_GTEST_PLUGIN: " << __func__
                       << " is implemented in later versions of OHOS, please update." << std::endl;
    return napi_ok;
...
napi_status __attribute__((weak))  // CC-OFF(G.FMT.10) project code style
napi_wrap_hybrid_s([[maybe_unused]] napi_env env, [[maybe_unused]] napi_value js_object,
                   [[maybe_unused]] void *native_object, [[maybe_unused]] napi_finalize finalize_cb,
                   [[maybe_unused]] void *finalize_hint, [[maybe_unused]] const napi_type_tag *type_tag,
