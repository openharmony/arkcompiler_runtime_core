...
#ifndef PANDA_PLUGINS_ETS_RUNTIME_REGEXP_REGEXP_16_H
#define PANDA_PLUGINS_ETS_RUNTIME_REGEXP_REGEXP_16_H
...
class RegExp16 {
public:
    static Pcre2Obj CreatePcre2Object(const uint16_t *pattern, uint32_t flags);
...
#endif  // PANDA_PLUGINS_ETS_RUNTIME_REGEXP_REGEXP_16_H