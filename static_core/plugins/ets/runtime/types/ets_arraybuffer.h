...
#ifndef PANDA_RUNTIME_ETS_FFI_CLASSES_ETS_ARRAYBUFFER_H
#define PANDA_RUNTIME_ETS_FFI_CLASSES_ETS_ARRAYBUFFER_H
...
#endif  // PANDA_RUNTIME_ETS_FFI_CLASSES_ETS_ARRAYBUFFER_H
