...
#ifndef PANDA_PLUGINS_ETS_STDLIB_NATIVE_STD_CORE_REGEXP_REGEXP_8_H
#define PANDA_PLUGINS_ETS_STDLIB_NATIVE_STD_CORE_REGEXP_REGEXP_8_H
...
struct RegExp8CompileAndTestData {
...
public:
    ...
    static bool CompileAndTest(const RegExp8CompileAndTestData &data, int32_t &endIndex);
    static RegExpExecResult Execute(Pcre2Obj re, uint32_t matchFlags, const uint8_t *str, const int len,
                                    const int startOffset);
    // CC-OFFNXT(G.FUN.01, huge_method) solid logic
    static bool TestMatch(Pcre2Obj re, uint32_t matchFlags, const uint8_t *str, int len, int startOffset,
                          int32_t &endIndex);
...
#endif  // PANDA_PLUGINS_ETS_STDLIB_NATIVE_STD_CORE_REGEXP_REGEXP_8_H
