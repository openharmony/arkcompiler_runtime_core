...
def main():
    ...
    parser.add_argument(
        "--escompat-dir", type=Path, help="Directory containing escompat files"
    )
    parser.add_argument(
    ...
    if not std_lib_dir or not escompat_lib_dir or not arkruntime_lib_dir or not target_dir or not json_file:
        parser.error("std-dir, escompat-dir, arkruntime-dir, target-dir, and json-files are required.")
