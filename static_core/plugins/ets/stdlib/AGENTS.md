...
- **ERB** (`.erb`): `Array_escompat.erb` → `Array.ets`
...
- `Array_escompat.erb` → `std/core/Array.ets`
- `Array_builtin.erb` → `std/core/BuiltinArray.ets`
- `Array_common.erb` → `BuiltinArray.ets` and `Array.ets`
