...
void BuildCoreArrayGetUnsafeIntrinsic(const BytecodeInstruction *bcInst, bool accRead);
void BuildCoreArraySetUnsafeIntrinsic(const BytecodeInstruction *bcInst, bool accRead);
void BuildCoreArrayGetBufferIntrinsic(const BytecodeInstruction *bcInst, bool accRead);
