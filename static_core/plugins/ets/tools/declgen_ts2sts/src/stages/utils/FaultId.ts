...
export enum FaultID {
  ...
  ConstLiteralToType,
  AddDeclareToClass,
  AddDeclareToInterface,
  FunctionType,
  MergeDuplicatedMethods,
  MergeDuplicatedFunctions,
  MergeDuplicatedConstructors,
  MergeDuplicatedIndexSignatures,
  BooleanLiteral,
  NoImportType,
