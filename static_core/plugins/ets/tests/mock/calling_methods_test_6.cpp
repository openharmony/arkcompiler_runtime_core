...
TEST_F(MethodsTest, CallMethodsTestGeneral6)
{
    ...
    env_->CallNonvirtualVoidMethod(obj, cCls, voidId, static_cast<ets_int>(1), static_cast<ets_int>(121));
    ...
    EXPECT_EQ(
        env_->CallNonvirtualBooleanMethod(obj, cCls, booleanId, static_cast<ets_boolean>(1), static_cast<ets_int>(121)),
        static_cast<ets_boolean>(0));
    EXPECT_EQ(env_->CallNonvirtualByteMethod(obj, cCls, byteId, static_cast<ets_byte>(1), static_cast<ets_int>(121)),
              static_cast<ets_byte>(0));
    EXPECT_EQ(env_->CallNonvirtualCharMethod(obj, cCls, charId, static_cast<ets_char>(1), static_cast<ets_int>(121)),
              static_cast<ets_char>(0));
    EXPECT_EQ(env_->CallNonvirtualShortMethod(obj, cCls, shortId, static_cast<ets_short>(1), static_cast<ets_int>(121)),
              static_cast<ets_short>(0));
    EXPECT_EQ(env_->CallNonvirtualIntMethod(obj, cCls, intId), static_cast<ets_int>(0));
    EXPECT_EQ(env_->CallNonvirtualLongMethod(obj, cCls, longId, static_cast<ets_long>(1), static_cast<ets_int>(121)),
              static_cast<ets_long>(0));
    EXPECT_EQ(
        env_->CallNonvirtualFloatMethod(obj, cCls, floatId, static_cast<ets_float>(1.0F), static_cast<ets_int>(121)),
        static_cast<ets_float>(0.0F));
    EXPECT_EQ(
        env_->CallNonvirtualDoubleMethod(obj, cCls, doubleId, static_cast<ets_double>(1.0), static_cast<ets_int>(121)),
    ...
    CallNonvirtualVoidMethodListHelper(env_, obj, cCls, voidId, static_cast<ets_int>(1), static_cast<ets_int>(121));
    EXPECT_EQ(env_->GetIntField(obj, dMemberId), static_cast<ets_int>(0));
    ...
    EXPECT_EQ(env_->CallNonvirtualBooleanMethod(obj, nullptr, booleanId, static_cast<ets_boolean>(1),
                                                static_cast<ets_int>(121)),
              static_cast<ets_boolean>(0));
    EXPECT_EQ(env_->CallNonvirtualByteMethod(obj, nullptr, byteId, static_cast<ets_byte>(1), static_cast<ets_int>(121)),
              static_cast<ets_byte>(0));
    EXPECT_EQ(env_->CallNonvirtualCharMethod(obj, nullptr, charId, static_cast<ets_char>(1), static_cast<ets_int>(121)),
              static_cast<ets_char>(0));
    EXPECT_EQ(
        env_->CallNonvirtualShortMethod(obj, nullptr, shortId, static_cast<ets_short>(1), static_cast<ets_int>(121)),
        static_cast<ets_short>(0));
    EXPECT_EQ(env_->CallNonvirtualIntMethod(obj, nullptr, intId), static_cast<ets_int>(0));
    EXPECT_EQ(env_->CallNonvirtualLongMethod(obj, nullptr, longId, static_cast<ets_long>(1), static_cast<ets_int>(121)),
              static_cast<ets_long>(0));
    EXPECT_EQ(
        env_->CallNonvirtualFloatMethod(obj, nullptr, floatId, static_cast<ets_float>(1.0F), static_cast<ets_int>(121)),
        static_cast<ets_float>(0.0F));
