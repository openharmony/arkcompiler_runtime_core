...
function main() {
    ...
    function message(data) {
        console.log('Benchmark result: equality_objects_j2a ' + data);
    }
    ...
    comparison(bench.stsObj, bench.stsObj, equal, 'object ');

    comparison(bench.stsObj, bench.stsObjCopy, equal, 'object by link ');

    comparison(bench.stsObj, bench.stsObjOther, noEqual, 'object different object ');
