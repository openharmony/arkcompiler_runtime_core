                   ...
                   ani_object f14, ani_double f15)
{
    ...
    CHECK_EQUAL(env->FindClass("LNativeModule;", &nativeModule), ANI_OK);

    ani_class byteWrapper;
    CHECK_EQUAL(env->FindClass("LByteWrapper;", &byteWrapper), ANI_OK);
    ani_class shortWrapper;
    CHECK_EQUAL(env->FindClass("LShortWrapper;", &shortWrapper), ANI_OK);
    ani_class intWrapper;
    CHECK_EQUAL(env->FindClass("LIntWrapper;", &intWrapper), ANI_OK);
    ani_class longWrapper;
    CHECK_EQUAL(env->FindClass("LLongWrapper;", &longWrapper), ANI_OK);
    ani_class floatWrapper;
    CHECK_EQUAL(env->FindClass("LFloatWrapper;", &floatWrapper), ANI_OK);
    ani_class doubleWrapper;
    CHECK_EQUAL(env->FindClass("LDoubleWrapper;", &doubleWrapper), ANI_OK);
