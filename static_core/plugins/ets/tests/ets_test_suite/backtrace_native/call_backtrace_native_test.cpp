...
namespace ark::test {
class BackTraceNativeTest : public testing::Test {
public:
    void SetUp() override {}
...
TEST_F(BackTraceNativeTest, BackTraceNativeTestCase)
{
    ...
    auto result = Runtime::GetCurrent()->ExecutePandaFile(pandafile, "call_backtrace_native.ETSGLOBAL::main", {});
    EXPECT_TRUE(result);
}
