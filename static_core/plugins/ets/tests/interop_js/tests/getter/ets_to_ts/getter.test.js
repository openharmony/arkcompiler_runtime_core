...
const createPublicGetterClassFromEts = etsVm.getFunction(
	'Lgetter/test/ETSGLOBAL;',
	'create_public_getter_class_from_ets'
);

const ProtectedGetterOrigenClass = etsVm.getClass(
	'Lgetter/test/ProtectedGetterOrigenClass;'
);
const createProtectedGetterOrigenClassFromEts = etsVm.getFunction(
	'Lgetter/test/ETSGLOBAL;',
	'create_protected_getter_origen_class_from_ets'
);

const ProtectedGetterInheritanceClass = etsVm.getClass(
	'Lgetter/test/ProtectedGetterInheritanceClass;'
);
const createProtectedGetterInheritanceClassFromEts = etsVm.getFunction(
	'Lgetter/test/ETSGLOBAL;',
...
const createPrivateGetterClassFromEts = etsVm.getFunction(
	'Lgetter/test/ETSGLOBAL;',
	'create_private_getter_class_from_ets'
);

const PrivateGetterInheritanceClass = etsVm.getClass(
	'Lgetter/test/PrivateGetterInheritanceClass;'
);
const createPrivateGetterInheritanceClassFromEts = etsVm.getFunction(
	'Lgetter/test/ETSGLOBAL;',
	'create_private_getter_inheritance_class_from_ets'
);

const UnionTypeClass = etsVm.getClass('Lgetter/test/UnionTypeClass;');
const createUnionTypeGetterClassFromEts = etsVm.getFunction(
	'Lgetter/test/ETSGLOBAL;',
	'create_union_type_getter_class_from_ets'
);

const AnyTypeClass = etsVm.getClass('Lgetter/test/AnyTypeClass;');
const createAnyTypeGetterClassFromEtsString = etsVm.getFunction(
	'Lgetter/test/ETSGLOBAL;',
	'create_any_type_getter_class_from_ets_string'
);
const createAnyTypeGetterClassFromEtsInt = etsVm.getFunction(
	'Lgetter/test/ETSGLOBAL;',
	'create_any_type_getter_class_from_ets_int'
);
const createAnyTypeGetterClassFromEtsBool = etsVm.getFunction(
	'Lgetter/test/ETSGLOBAL;',
	'create_any_type_getter_class_from_ets_bool'
);
const createAnyTypeGetterClassFromEtsArr = etsVm.getFunction(
	'Lgetter/test/ETSGLOBAL;',
	'create_any_type_getter_class_from_ets_arr'
);
const createAnyTypeGetterClassFromEtsObj = etsVm.getFunction(
	'Lgetter/test/ETSGLOBAL;',
	'create_any_type_getter_class_from_ets_obj'
);
const createAnyTypeGetterClassFromEtsTuple = etsVm.getFunction(
	'Lgetter/test/ETSGLOBAL;',
	'create_any_type_getter_class_from_ets_tuple'
);
const createAnyTypeGetterClassFromEtsUnion = etsVm.getFunction(
	'Lgetter/test/ETSGLOBAL;',
	'create_any_type_getter_class_from_ets_union'
);

const SubsetByRef = etsVm.getClass('Lgetter/test/SubsetByRef;');
const createSubsetByRefGetterClassFromEts = etsVm.getFunction(
	'Lgetter/test/ETSGLOBAL;',
	'create_subset_by_ref_getter_class_from_ets'
);

const SubsetByValueClass = etsVm.getClass('Lgetter/test/SubsetByValueClass;');
const createSubsetByValueGetterClassFromEts = etsVm.getFunction(
	'Lgetter/test/ETSGLOBAL;',
