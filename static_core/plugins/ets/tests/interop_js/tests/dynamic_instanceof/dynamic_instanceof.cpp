...
TEST_F(EtsInteropInstanceOf, Test1)
{
    auto ret = CallEtsMethod<bool>("Test1");
    ASSERT_EQ(ret, true);
}

TEST_F(EtsInteropInstanceOf, Test2)
{
    auto ret = CallEtsMethod<bool>("Test2");
    ASSERT_EQ(ret, true);
}

TEST_F(EtsInteropInstanceOf, Test3)
{
    auto ret = CallEtsMethod<bool>("Test3");
    ASSERT_EQ(ret, true);
}

TEST_F(EtsInteropInstanceOf, Test4)
{
    auto ret = CallEtsMethod<bool>("Test4");
    ASSERT_EQ(ret, true);
}

TEST_F(EtsInteropInstanceOf, Test5)
{
    auto ret = CallEtsMethod<bool>("Test5");
    ASSERT_EQ(ret, true);
}

TEST_F(EtsInteropInstanceOf, Test6)
{
