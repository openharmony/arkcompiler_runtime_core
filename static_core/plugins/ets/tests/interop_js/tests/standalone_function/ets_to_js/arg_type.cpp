...
TEST_F(EtsInteropScenariosEtsToJs, DISABLED_test_function_arg_type_class_call)
{
...
// NOTE #8924 Can be enabled once a way to access class object can be suggested in the JS code
// (see the referenced file)
TEST_F(EtsInteropScenariosEtsToJs, DISABLED_test_function_arg_type_interface_call)
{
