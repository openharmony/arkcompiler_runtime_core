...
ASSERT_TRUE(etsArrayConcat1.concat(etsArrayConcat2).toString() === "1,2,3,4,5,6,7,8" && etsArrayConcat1.concat(localArray).toString() === "1,2,3,4,1,2,3,4" && localArray.concat(etsArrayConcat1).toString() === "1,2,3,4,1,2,3,4");
ASSERT_TRUE(etsArrayCopyWithin1.copyWithin(1).toString() === "1,1,2,3" && etsArrayCopyWithin2.copyWithin(0, 2).toString() === "3,4,3,4" && etsArrayCopyWithin3.copyWithin(0, 1, 3).toString() === "2,3,3,4");
...
ASSERT_TRUE(etsArray.toSpliced(1).toString() === "1" && etsArray.toSpliced(1, 2).toString() === "1,4" && etsArray.toSpliced(1, 2, 3).toString() === "1,3,4");
ASSERT_TRUE(etsArrayUnshift.unshift() === 4 && etsArrayUnshift.unshift(1) === 5 && etsArrayUnshift.unshift(1, 2) === 7 && etsArrayUnshift.unshift(1, 2, 3) === 10);
