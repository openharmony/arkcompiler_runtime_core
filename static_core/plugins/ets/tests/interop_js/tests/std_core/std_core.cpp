...
class StdCoreTest : public EtsInteropTest {};

// #22991
TEST_F(StdCoreTest, DISABLED_std_core_array)
{
    ASSERT_EQ(true, RunJsTestSuite("std_core_array.js"));
}

// NOTE(oignatenko) uncomment Array_TestJSLength code after interop is implemented from JS to eTS
// #22991
TEST_F(StdCoreTest, DISABLED_std_core_array_length)
{
    ASSERT_EQ(true, RunJsTestSuite("array_js_suites/test_length.js"));
}

// #26303 TEST_F(StdCoreTest, std_core_array_pop) array_js_suites/test_pop.js

// #22991
TEST_F(StdCoreTest, DISABLED_std_core_array_fill)
{
    ASSERT_EQ(true, RunJsTestSuite("array_js_suites/test_fill.js"));
}

// #22991
TEST_F(StdCoreTest, DISABLED_std_core_array_shift)
{
...
// #22991
TEST_F(StdCoreTest, DISABLED_std_core_array_slice)
{
...
// #22991
TEST_F(StdCoreTest, DISABLED_std_core_array_splice)
{
...
// #22991
TEST_F(StdCoreTest, DISABLED_std_core_array_to_spliced)
{
...
// #22991
TEST_F(StdCoreTest, DISABLED_std_core_array_copy_within)
{
...
// #22991
TEST_F(StdCoreTest, DISABLED_std_core_array_with)
{
    ASSERT_EQ(true, RunJsTestSuite("array_js_suites/test_with.js"));
}

// #22991
TEST_F(StdCoreTest, DISABLED_std_core_array_last_index_of)
{
...
// #22991
TEST_F(StdCoreTest, DISABLED_std_core_array_to_reversed)
{
