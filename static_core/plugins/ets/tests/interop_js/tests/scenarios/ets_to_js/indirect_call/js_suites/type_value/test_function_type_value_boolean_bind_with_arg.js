...
function test_function_type_value_boolean_bind_with_arg() {
	let boundWithArg = function_type_value_boolean.bind(null, true);

	ASSERT_EQ(boundWithArg(), false);
}

test_function_type_value_boolean_bind_with_arg();
