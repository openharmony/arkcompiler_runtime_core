...
class EtsSetterEtsToJsTest : public EtsInteropTest {};

TEST_F(EtsSetterEtsToJsTest, check_setter_abstract)
{
    ASSERT_TRUE(RunJsTestSuite("check_setter_abstract.js"));
}

TEST_F(EtsSetterEtsToJsTest, check_setter_union)
{
    ASSERT_TRUE(RunJsTestSuite("check_setter_union.js"));
}

TEST_F(EtsSetterEtsToJsTest, check_setter_interface)
{
    ASSERT_TRUE(RunJsTestSuite("check_setter_interface.js"));
}

TEST_F(EtsSetterEtsToJsTest, check_setter_subset_ref)
{
    ASSERT_TRUE(RunJsTestSuite("check_setter_subset_ref.js"));
}

TEST_F(EtsSetterEtsToJsTest, check_setter_user_class)
{
    ASSERT_TRUE(RunJsTestSuite("check_setter_user_class.js"));
}

TEST_F(EtsSetterEtsToJsTest, check_setter_subset_value)
{
    ASSERT_TRUE(RunJsTestSuite("check_setter_subset_value.js"));
}

TEST_F(EtsSetterEtsToJsTest, check_setter_any_type)
{
