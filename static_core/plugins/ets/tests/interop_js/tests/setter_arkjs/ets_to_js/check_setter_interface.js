...
const string = 'string';
const InterfaceSetter = etsVm.getClass('Lsetter_ets/InterfaceSetter;');
const createInterfaceClass = etsVm.getFunction('Lsetter_ets/ETSGLOBAL;', 'create_interface_class');
