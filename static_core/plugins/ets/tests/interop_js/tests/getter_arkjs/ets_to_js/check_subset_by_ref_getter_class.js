...
const SubsetByRef = etsVm.getClass('Lgetter/SubsetByRef;');
const createSubsetByRefGetterClassFromEts = etsVm.getFunction('Lgetter/ETSGLOBAL;', 'create_subset_by_ref_getter_class_from_ets');
