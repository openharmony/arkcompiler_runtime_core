...
export class DerivedGeneric<T, U, V>
  extends BaseGeneric<T, U>
  implements IGeneric0<U>, IGeneric1<IGeneric0<V>>
{
  I0Method(a: U): U {
    return a;
  }
...
function testGenerics() {
  ...
  AssertEq(
    Identity(THREE + TWENTY_TWO_HUNDREDTH).toFixed(PRECISION),
