...
function testNewArray(): void {
    ...
    let res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [boolArray, boolObj]);
    ASSERT_TRUE(res.unwrapToBoolean());
    ...
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [byteArray, byteObj]);
    ASSERT_TRUE(res.unwrapToBoolean());
    ...
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [charArray, charObj]);
    ASSERT_TRUE(res.unwrapToBoolean());
    ...
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [shortArray, shortObj]);
    ASSERT_TRUE(res.unwrapToBoolean());

    let intClass = STValue.findClass('std.core.Int');
    let intObj = intClass.classInstantiate('i:', [STValue.wrapInt(0)]);
    let intArray = STValue.newArray(5, intObj);
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [intArray, intObj]);
    ASSERT_TRUE(res.unwrapToBoolean());
    ...
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [longArray, longObj]);
    ASSERT_TRUE(res.unwrapToBoolean());
    ...
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [floatArray, floatObj]);
    ASSERT_TRUE(res.unwrapToBoolean());
    ...
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [doubleArray, doubleObj]);
    ASSERT_TRUE(res.unwrapToBoolean());

    let undefArray = STValue.newArray(5, STValue.getUndefined());
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [undefArray, STValue.getUndefined()]);
    ASSERT_TRUE(res.unwrapToBoolean());

    let strArray = STValue.newArray(5, STValue.wrapString('hello world!'));
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [strArray, STValue.wrapString('hello world!')]);
    ASSERT_TRUE(res.unwrapToBoolean());
...
function testNewTwoDimensionalArray(): void {
    ...
    let res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [twoDimBoolArray, boolArray]);
    ASSERT_TRUE(res.unwrapToBoolean());
    ...
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [twoDimByteArray, byteArray]);
    ASSERT_TRUE(res.unwrapToBoolean());
    ...
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [twoDimCharArray, charArray]);
    ASSERT_TRUE(res.unwrapToBoolean());
    ...
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [twoDimShortArray, shortArray]);
    ASSERT_TRUE(res.unwrapToBoolean());
    ...
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [twoDimIntArray, intArray]);
    ASSERT_TRUE(res.unwrapToBoolean());
    ...
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [twoDimLongArray, longArray]);
    ASSERT_TRUE(res.unwrapToBoolean());
    ...
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [twoDimFloatArray, floatArray]);
    ASSERT_TRUE(res.unwrapToBoolean());
    ...
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [twoDimDoubleArray, doubleArray]);
    ASSERT_TRUE(res.unwrapToBoolean());

    let undefArray = STValue.newArray(5, STValue.getUndefined());
    let twoDimUndefArray = STValue.newArray(5, undefArray);
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [twoDimUndefArray, undefArray]);
    ASSERT_TRUE(res.unwrapToBoolean());

    let strArray = STValue.newArray(5, STValue.wrapString('hello world!'));
    let twoDimStrArray = STValue.newArray(5, strArray);
    res = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [twoDimStrArray, strArray]);
    ASSERT_TRUE(res.unwrapToBoolean());

    let invalidRes = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [twoDimIntArray, intObj]);
    ASSERT_TRUE(!invalidRes.unwrapToBoolean());

    invalidRes = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [twoDimIntArray, shortArray]);
    ASSERT_TRUE(!invalidRes.unwrapToBoolean());

    invalidRes = ns.namespaceInvokeFunction('checkArray', 'C{std.core.Array}Y:z', [intArray, intArray]);
    ASSERT_TRUE(!invalidRes.unwrapToBoolean());
}
