...
export function create_class_with_arg_from_ts(
...
export function create_child_class_with_arg_from_ts(
  arg: ClassConstructor,
): ChildClass {
...
export function create_anonymous_class_create_class_with_arg_from_ts(
  arg: ClassConstructor,
) {
...
export const anonymousClassCreateMainInstance = new AnonymousClassCreateClass(
  MainClass,
);

export const anonymousClassCreateIIFEInstance = new AnonymousClassCreateClass(
  IIFEClass,
);

export const IIFECreateClassMain = (function (
  ctor: new (_value: number) => MainClass,
  value: number,
) {
  return new ctor(value);
})(MainClass, ts_int);

export const IIFECreateClassAnonymous = (function (
  ctor: new (_value: number) => InstanceType<typeof AnonymousClass>,
  value: number,
) {
  return new ctor(value);
})(AnonymousClass, ts_int);

export const IIFECreateClass = (function (
  ctor: new (_value: number) => InstanceType<typeof IIFEClass>,
  value: number,
) {
  return new ctor(value);
})(IIFEClass, ts_int);
...
export function check_instance<T, U>(
  mainClass: new (...args: any[]) => T,
  instance: U,
): boolean {
  if (
    typeof mainClass !== "function" ||
