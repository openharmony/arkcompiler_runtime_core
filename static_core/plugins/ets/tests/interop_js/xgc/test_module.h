...
public:
    ...
    {
        InteropCtx::Current()->SetEcmaVMInterface(&g_ecmaVMIface);
        ets::PandaEtsVM::GetCurrent()->GetGC()->AddListener(&g_gcListener);
        InteropCtx::Current()->GetSTSVMInterface()->OnVMDetach();
