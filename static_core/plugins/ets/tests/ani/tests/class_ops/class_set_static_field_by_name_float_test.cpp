...
TEST_F(ClassSetStaticFieldByNameFloatTest, check_initialization0)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_by_name_float_test.Parent", &cls), ANI_OK);

    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Grandchild"));
    const ani_float floatValue = 2.2;
    ASSERT_EQ(env_->Class_SetStaticFieldByName_Float(cls, "parentStaticField", floatValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Grandchild"));
}

TEST_F(ClassSetStaticFieldByNameFloatTest, check_initialization1)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_by_name_float_test.Parent", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Grandchild"));
    const ani_float floatValue = 2.2;
    ASSERT_EQ(env_->Class_SetStaticFieldByName_Float(cls, "childStaticField", floatValue), ANI_NOT_FOUND);
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Grandchild"));
}

TEST_F(ClassSetStaticFieldByNameFloatTest, check_initialization2)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_by_name_float_test.Parent", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Grandchild"));
    const ani_float floatValue = 2.2;
    ASSERT_EQ(env_->Class_SetStaticFieldByName_Float(cls, "grandchildStaticField", floatValue), ANI_NOT_FOUND);
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Grandchild"));
}

TEST_F(ClassSetStaticFieldByNameFloatTest, check_initialization3)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_by_name_float_test.Child", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldByNameFloatTest, check_initialization4)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_by_name_float_test.Child", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Grandchild"));
    const ani_float floatValue = 2.2;
    ASSERT_EQ(env_->Class_SetStaticFieldByName_Float(cls, "childStaticField", floatValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Grandchild"));
}

TEST_F(ClassSetStaticFieldByNameFloatTest, check_initialization5)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_by_name_float_test.Child", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldByNameFloatTest, check_initialization6)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_by_name_float_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldByNameFloatTest, check_initialization7)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_by_name_float_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldByNameFloatTest, check_initialization8)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_by_name_float_test.Grandchild", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Grandchild"));
    const ani_float floatValue = 2.2;
    ASSERT_EQ(env_->Class_SetStaticFieldByName_Float(cls, "grandchildStaticField", floatValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Child"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_by_name_float_test.Grandchild"));
}
