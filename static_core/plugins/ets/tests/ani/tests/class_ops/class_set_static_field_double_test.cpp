...
TEST_F(ClassSetStaticFieldDoubleTest, check_initialization0)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_double_test.Parent", &cls), ANI_OK);

    ani_static_field field {};
    ASSERT_EQ(env_->Class_FindStaticField(cls, "parentStaticField", &field), ANI_OK);

    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_double_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_double_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_double_test.Grandchild"));
    const ani_double doubleValue = 16.05;
    ASSERT_EQ(env_->Class_SetStaticField_Double(cls, field, doubleValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_double_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_double_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_double_test.Grandchild"));
}

TEST_F(ClassSetStaticFieldDoubleTest, check_initialization1)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_double_test.Parent", &cls), ANI_OK);

    ani_class fieldClass {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_double_test.Child", &fieldClass), ANI_OK);
    ani_static_field field {};
    ...
    ASSERT_EQ(env_->Class_SetStaticField_Double(cls, field, doubleValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_double_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_double_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_double_test.Grandchild"));
}

TEST_F(ClassSetStaticFieldDoubleTest, check_initialization2)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_double_test.Parent", &cls), ANI_OK);

    ani_class fieldClass {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_double_test.Grandchild", &fieldClass), ANI_OK);
    ani_static_field field {};
    ...
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_double_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_double_test.Child"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_double_test.Grandchild"));
}

TEST_F(ClassSetStaticFieldDoubleTest, check_initialization3)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_double_test.Child", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldDoubleTest, check_initialization4)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_double_test.Child", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldDoubleTest, check_initialization5)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_double_test.Child", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldDoubleTest, check_initialization6)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_double_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldDoubleTest, check_initialization7)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_double_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldDoubleTest, check_initialization8)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_double_test.Grandchild", &cls), ANI_OK);
