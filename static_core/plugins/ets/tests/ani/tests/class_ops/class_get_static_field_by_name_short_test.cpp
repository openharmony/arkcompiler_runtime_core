...
TEST_F(ClassGetStaticFieldByNameShortTest, check_initialization0)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_short_test.Parent", &cls), ANI_OK);

    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Grandchild"));
    ani_short shortValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Short(cls, "parentStaticField", &shortValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldByNameShortTest, check_initialization1)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_short_test.Parent", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Grandchild"));
    ani_short shortValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Short(cls, "childStaticField", &shortValue), ANI_NOT_FOUND);
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldByNameShortTest, check_initialization2)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_short_test.Parent", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Grandchild"));
    ani_short shortValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Short(cls, "grandchildStaticField", &shortValue), ANI_NOT_FOUND);
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldByNameShortTest, check_initialization3)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_short_test.Child", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldByNameShortTest, check_initialization4)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_short_test.Child", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Grandchild"));
    ani_short shortValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Short(cls, "childStaticField", &shortValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldByNameShortTest, check_initialization5)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_short_test.Child", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldByNameShortTest, check_initialization6)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_short_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldByNameShortTest, check_initialization7)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_short_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldByNameShortTest, check_initialization8)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_short_test.Grandchild", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Grandchild"));
    ani_short shortValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Short(cls, "grandchildStaticField", &shortValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Child"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_short_test.Grandchild"));
}
