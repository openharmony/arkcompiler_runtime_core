...
public:
    void GetMethodData(ani_class *clsResult, ani_static_method *methodResult)
    {
        ...
        ASSERT_EQ(env_->Class_GetStaticMethod(cls, "sum", "II:I", &method), ANI_OK);
...
TEST_F(CallStaticMethodTest, call_static_method_int)
{
    ...
    ani_int sum;
    ASSERT_EQ(env_->c_api->Class_CallStaticMethod_Int(env_, cls, method, &sum, 5U, 6U), ANI_OK);
    ASSERT_EQ(sum, 5U + 6U);
}
...
TEST_F(CallStaticMethodTest, call_static_method_int_v)
{
    ...
    ani_int sum;
    ASSERT_EQ(env_->Class_CallStaticMethod_Int(cls, method, &sum, 5U, 6U), ANI_OK);
    ASSERT_EQ(sum, 5U + 6U);
}
...
TEST_F(CallStaticMethodTest, call_static_method_int_invalid_cls)
{
    ...
    ani_int sum;
    ASSERT_EQ(env_->c_api->Class_CallStaticMethod_Int(env_, nullptr, method, &sum, 5U, 6U), ANI_INVALID_ARGS);
}
...
TEST_F(CallStaticMethodTest, call_static_method_int_invalid_method)
{
    ...
    ani_int sum;
    ASSERT_EQ(env_->c_api->Class_CallStaticMethod_Int(env_, cls, nullptr, &sum, 5U, 6U), ANI_INVALID_ARGS);
}
...
TEST_F(CallStaticMethodTest, call_static_method_int_invalid_result)
{
    ...
    ASSERT_EQ(env_->c_api->Class_CallStaticMethod_Int(env_, cls, method, nullptr, 5U, 6U), ANI_INVALID_ARGS);
}
...
TEST_F(CallStaticMethodTest, call_static_method_int_v_invalid_cls)
{
    ...
    ani_int sum;
    ASSERT_EQ(env_->Class_CallStaticMethod_Int(nullptr, method, &sum, 5U, 6U), ANI_INVALID_ARGS);
}
...
TEST_F(CallStaticMethodTest, call_static_method_int_v_invalid_method)
{
    ...
    ani_int sum;
    ASSERT_EQ(env_->Class_CallStaticMethod_Int(cls, nullptr, &sum, 5U, 6U), ANI_INVALID_ARGS);
}
...
TEST_F(CallStaticMethodTest, call_static_method_int_v_invalid_result)
{
    ...
    ASSERT_EQ(env_->Class_CallStaticMethod_Int(cls, method, nullptr, 5U, 6U), ANI_INVALID_ARGS);
}
