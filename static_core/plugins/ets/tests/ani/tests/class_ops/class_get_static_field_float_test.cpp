...
TEST_F(ClassGetStaticFieldFloatTest, check_initialization0)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_float_test.Parent", &cls), ANI_OK);

    ani_static_field field {};
    ASSERT_EQ(env_->Class_FindStaticField(cls, "parentStaticField", &field), ANI_OK);

    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_float_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_float_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_float_test.Grandchild"));
    ani_float floatValue {};
    ASSERT_EQ(env_->Class_GetStaticField_Float(cls, field, &floatValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_float_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_float_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_float_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldFloatTest, check_initialization1)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_float_test.Parent", &cls), ANI_OK);

    ani_class fieldClass {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_float_test.Child", &fieldClass), ANI_OK);
    ani_static_field field {};
    ...
    ASSERT_EQ(env_->Class_GetStaticField_Float(cls, field, &floatValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_float_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_float_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_float_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldFloatTest, check_initialization2)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_float_test.Parent", &cls), ANI_OK);

    ani_class fieldClass {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_float_test.Grandchild", &fieldClass), ANI_OK);
    ani_static_field field {};
    ...
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_float_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_float_test.Child"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_float_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldFloatTest, check_initialization3)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_float_test.Child", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldFloatTest, check_initialization4)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_float_test.Child", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldFloatTest, check_initialization5)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_float_test.Child", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldFloatTest, check_initialization6)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_float_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldFloatTest, check_initialization7)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_float_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldFloatTest, check_initialization8)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_float_test.Grandchild", &cls), ANI_OK);
