...
TEST_F(ClassGetStaticFieldByNameRefTest, check_initialization0)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_ref_test.Parent", &cls), ANI_OK);

    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Grandchild"));
    ani_ref refValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Ref(cls, "parentStaticField", &refValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldByNameRefTest, check_initialization1)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_ref_test.Parent", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Grandchild"));
    ani_ref refValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Ref(cls, "childStaticField", &refValue), ANI_NOT_FOUND);
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldByNameRefTest, check_initialization2)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_ref_test.Parent", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Grandchild"));
    ani_ref refValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Ref(cls, "grandchildStaticField", &refValue), ANI_NOT_FOUND);
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldByNameRefTest, check_initialization3)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_ref_test.Child", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldByNameRefTest, check_initialization4)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_ref_test.Child", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Grandchild"));
    ani_ref refValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Ref(cls, "childStaticField", &refValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldByNameRefTest, check_initialization5)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_ref_test.Child", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldByNameRefTest, check_initialization6)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_ref_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldByNameRefTest, check_initialization7)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_ref_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldByNameRefTest, check_initialization8)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_ref_test.Grandchild", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Grandchild"));
    ani_ref refValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Ref(cls, "grandchildStaticField", &refValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Child"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_ref_test.Grandchild"));
}
