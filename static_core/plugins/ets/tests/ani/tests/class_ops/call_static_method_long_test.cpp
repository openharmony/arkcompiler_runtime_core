...
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("call_static_method_long_test.Parent", &cls), ANI_OK);

    ani_static_method method {};
    ASSERT_EQ(env_->Class_FindStaticMethod(cls, "parentStaticMethod", ":l", &method), ANI_OK);

    ASSERT_FALSE(IsRuntimeClassInitialized("call_static_method_long_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("call_static_method_long_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("call_static_method_long_test.Grandchild"));
    ani_long longValue;
    ASSERT_EQ(env_->Class_CallStaticMethod_Long(cls, method, &longValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("call_static_method_long_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("call_static_method_long_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("call_static_method_long_test.Grandchild"));
}
...
TEST_F(CallStaticMethodTest, check_initialization0_a)
{
    ...
    ani_value args;
    ani_long longValue;
    ASSERT_EQ(env_->Class_CallStaticMethod_Long_A(cls, method, &longValue, &args), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("call_static_method_long_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("call_static_method_long_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("call_static_method_long_test.Grandchild"));
}
...
TEST_F(CallStaticMethodTest, check_initialization1)
{
    ...
    ASSERT_EQ(env_->FindClass("call_static_method_long_test.Child", &methodClass), ANI_OK);
    ani_static_method method {};
    ASSERT_EQ(env_->Class_FindStaticMethod(methodClass, "childStaticMethod", ":l", &method), ANI_OK);
    ...
    ASSERT_EQ(env_->Class_CallStaticMethod_Long(cls, method, &longValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("call_static_method_long_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("call_static_method_long_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("call_static_method_long_test.Grandchild"));
}
...
TEST_F(CallStaticMethodTest, check_initialization2)
{
    ...
    ani_class methodClass {};
    ASSERT_EQ(env_->FindClass("call_static_method_long_test.Grandchild", &methodClass), ANI_OK);
    ani_static_method method {};
    ASSERT_EQ(env_->Class_FindStaticMethod(methodClass, "grandchildStaticMethod", ":l", &method), ANI_OK);
    ...
    ASSERT_TRUE(IsRuntimeClassInitialized("call_static_method_long_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("call_static_method_long_test.Child"));
    ASSERT_TRUE(IsRuntimeClassInitialized("call_static_method_long_test.Grandchild"));
}
...
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("call_static_method_long_test.Child", &cls), ANI_OK);
...
TEST_F(CallStaticMethodTest, check_initialization4)
{
    ...
    ani_static_method method {};
    ASSERT_EQ(env_->Class_FindStaticMethod(cls, "childStaticMethod", ":l", &method), ANI_OK);
...
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("call_static_method_long_test.Grandchild", &cls), ANI_OK);
...
TEST_F(CallStaticMethodTest, check_initialization8)
{
    ...
    ani_static_method method {};
    ASSERT_EQ(env_->Class_FindStaticMethod(cls, "grandchildStaticMethod", ":l", &method), ANI_OK);
