...
TEST_F(ClassGetStaticFieldByNameCharTest, check_initialization0)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_char_test.Parent", &cls), ANI_OK);

    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Grandchild"));
    ani_char charValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Char(cls, "parentStaticField", &charValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldByNameCharTest, check_initialization1)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_char_test.Parent", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Grandchild"));
    ani_char charValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Char(cls, "childStaticField", &charValue), ANI_NOT_FOUND);
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldByNameCharTest, check_initialization2)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_char_test.Parent", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Grandchild"));
    ani_char charValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Char(cls, "grandchildStaticField", &charValue), ANI_NOT_FOUND);
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldByNameCharTest, check_initialization3)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_char_test.Child", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldByNameCharTest, check_initialization4)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_char_test.Child", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Grandchild"));
    ani_char charValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Char(cls, "childStaticField", &charValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldByNameCharTest, check_initialization5)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_char_test.Child", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldByNameCharTest, check_initialization6)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_char_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldByNameCharTest, check_initialization7)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_char_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldByNameCharTest, check_initialization8)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_char_test.Grandchild", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Grandchild"));
    ani_char charValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Char(cls, "grandchildStaticField", &charValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Child"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_char_test.Grandchild"));
}
