...
TEST_F(ClassSetStaticFieldRefTest, check_initialization0)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_ref_test.Parent", &cls), ANI_OK);

    ani_static_field field {};
    ASSERT_EQ(env_->Class_FindStaticField(cls, "parentStaticField", &field), ANI_OK);

    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_ref_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_ref_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_ref_test.Grandchild"));
    ani_string string {};
    ASSERT_EQ(env_->String_NewUTF8("test", 4U, &string), ANI_OK);
    ASSERT_EQ(env_->Class_SetStaticField_Ref(cls, field, string), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_ref_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_ref_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_ref_test.Grandchild"));
}

TEST_F(ClassSetStaticFieldRefTest, check_initialization1)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_ref_test.Parent", &cls), ANI_OK);

    ani_class fieldClass {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_ref_test.Child", &fieldClass), ANI_OK);
    ani_static_field field {};
    ...
    ASSERT_EQ(env_->Class_SetStaticField_Ref(cls, field, string), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_ref_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_ref_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_ref_test.Grandchild"));
}

TEST_F(ClassSetStaticFieldRefTest, check_initialization2)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_ref_test.Parent", &cls), ANI_OK);

    ani_class fieldClass {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_ref_test.Grandchild", &fieldClass), ANI_OK);
    ani_static_field field {};
    ...
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_ref_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_ref_test.Child"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_ref_test.Grandchild"));
}

TEST_F(ClassSetStaticFieldRefTest, check_initialization3)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_ref_test.Child", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldRefTest, check_initialization4)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_ref_test.Child", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldRefTest, check_initialization5)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_ref_test.Child", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldRefTest, check_initialization6)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_ref_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldRefTest, check_initialization7)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_ref_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldRefTest, check_initialization8)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_ref_test.Grandchild", &cls), ANI_OK);
