...
TEST_F(ClassGetStaticFieldByNameLongTest, check_initialization0)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_long_test.Parent", &cls), ANI_OK);

    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Grandchild"));
    ani_long longValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Long(cls, "parentStaticField", &longValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldByNameLongTest, check_initialization1)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_long_test.Parent", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Grandchild"));
    ani_long longValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Long(cls, "childStaticField", &longValue), ANI_NOT_FOUND);
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldByNameLongTest, check_initialization2)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_long_test.Parent", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Grandchild"));
    ani_long longValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Long(cls, "grandchildStaticField", &longValue), ANI_NOT_FOUND);
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldByNameLongTest, check_initialization3)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_long_test.Child", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldByNameLongTest, check_initialization4)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_long_test.Child", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Grandchild"));
    ani_long longValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Long(cls, "childStaticField", &longValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldByNameLongTest, check_initialization5)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_long_test.Child", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldByNameLongTest, check_initialization6)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_long_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldByNameLongTest, check_initialization7)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_long_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldByNameLongTest, check_initialization8)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_by_name_long_test.Grandchild", &cls), ANI_OK);
    ...
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Grandchild"));
    ani_long longValue {};
    ASSERT_EQ(env_->Class_GetStaticFieldByName_Long(cls, "grandchildStaticField", &longValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Child"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_by_name_long_test.Grandchild"));
}
