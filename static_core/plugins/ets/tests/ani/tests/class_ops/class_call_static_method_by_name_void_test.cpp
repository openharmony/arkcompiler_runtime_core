...
TEST_F(ClassCallStaticMethodByNameVoidTest, call_static_method_by_name_void_v)
{
    ...
    ani_int sum;
    ASSERT_EQ(env_->Class_CallStaticMethodByName_Void(cls, "voidMethod", nullptr, a, b), ANI_OK);
    ASSERT_EQ(env_->Class_CallStaticMethodByName_Int(cls, "getCount", nullptr, &sum), ANI_OK);
    ASSERT_EQ(sum, a + b);
}
...
TEST_F(ClassCallStaticMethodByNameVoidTest, call_static_method_by_name_void)
{
    ...
    ani_int sum;
    ASSERT_EQ(env_->c_api->Class_CallStaticMethodByName_Void(env_, cls, "voidMethod", nullptr, a, b), ANI_OK);
    ASSERT_EQ(env_->Class_CallStaticMethodByName_Int(cls, "getCount", nullptr, &sum), ANI_OK);
    ASSERT_EQ(sum, a + b);
}
...
TEST_F(ClassCallStaticMethodByNameVoidTest, call_static_method_by_name_void_v_invalid_name)
{
    ...
    ASSERT_EQ(env_->Class_CallStaticMethodByName_Void(cls, nullptr, nullptr, a, b), ANI_INVALID_ARGS);
    ASSERT_EQ(env_->Class_CallStaticMethodByName_Void(cls, "sum_not_exist", nullptr, a, b), ANI_NOT_FOUND);
}
...
TEST_F(ClassCallStaticMethodByNameVoidTest, call_static_method_by_name_void_v_invalid_class)
{
    ...
    ASSERT_EQ(env_->Class_CallStaticMethodByName_Void(nullptr, "voidMethod", nullptr, a, b), ANI_INVALID_ARGS);
}
