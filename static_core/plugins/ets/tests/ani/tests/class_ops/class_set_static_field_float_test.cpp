...
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_float_test.TestSetFloat", &cls), ANI_OK);
    ani_static_field field {};
...
{
    CheckFieldValue("class_set_static_field_float_test.TestSetFloatA", "float_value");
}

TEST_F(ClassSetStaticFieldFloatTest, combination_test3)
{
    CheckFieldValue("class_set_static_field_float_test.TestSetFloatFinal", "float_value");
}

TEST_F(ClassSetStaticFieldFloatTest, check_initialization0)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_float_test.Parent", &cls), ANI_OK);

    ani_static_field field {};
    ASSERT_EQ(env_->Class_FindStaticField(cls, "parentStaticField", &field), ANI_OK);

    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_float_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_float_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_float_test.Grandchild"));
    const ani_float floatValue = 20.03F;
    ASSERT_EQ(env_->Class_SetStaticField_Float(cls, field, floatValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_float_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_float_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_float_test.Grandchild"));
}

TEST_F(ClassSetStaticFieldFloatTest, check_initialization1)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_float_test.Parent", &cls), ANI_OK);

    ani_class fieldClass {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_float_test.Child", &fieldClass), ANI_OK);
    ani_static_field field {};
    ...
    ASSERT_EQ(env_->Class_SetStaticField_Float(cls, field, floatValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_float_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_float_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_set_static_field_float_test.Grandchild"));
}

TEST_F(ClassSetStaticFieldFloatTest, check_initialization2)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_float_test.Parent", &cls), ANI_OK);

    ani_class fieldClass {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_float_test.Grandchild", &fieldClass), ANI_OK);
    ani_static_field field {};
    ...
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_float_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_float_test.Child"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_set_static_field_float_test.Grandchild"));
}

TEST_F(ClassSetStaticFieldFloatTest, check_initialization3)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_float_test.Child", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldFloatTest, check_initialization4)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_float_test.Child", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldFloatTest, check_initialization5)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_float_test.Child", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldFloatTest, check_initialization6)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_float_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldFloatTest, check_initialization7)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_float_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassSetStaticFieldFloatTest, check_initialization8)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_set_static_field_float_test.Grandchild", &cls), ANI_OK);
