...
TEST_F(ClassGetStaticFieldShortTest, check_initialization0)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_short_test.Parent", &cls), ANI_OK);

    ani_static_field field {};
    ASSERT_EQ(env_->Class_FindStaticField(cls, "parentStaticField", &field), ANI_OK);

    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_short_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_short_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_short_test.Grandchild"));
    ani_short shortValue {};
    ASSERT_EQ(env_->Class_GetStaticField_Short(cls, field, &shortValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_short_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_short_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_short_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldShortTest, check_initialization1)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_short_test.Parent", &cls), ANI_OK);

    ani_class fieldClass {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_short_test.Child", &fieldClass), ANI_OK);
    ani_static_field field {};
    ...
    ASSERT_EQ(env_->Class_GetStaticField_Short(cls, field, &shortValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_short_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_short_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_short_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldShortTest, check_initialization2)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_short_test.Parent", &cls), ANI_OK);

    ani_class fieldClass {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_short_test.Grandchild", &fieldClass), ANI_OK);
    ani_static_field field {};
    ...
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_short_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_short_test.Child"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_short_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldShortTest, check_initialization3)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_short_test.Child", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldShortTest, check_initialization4)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_short_test.Child", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldShortTest, check_initialization5)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_short_test.Child", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldShortTest, check_initialization6)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_short_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldShortTest, check_initialization7)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_short_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldShortTest, check_initialization8)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_short_test.Grandchild", &cls), ANI_OK);
