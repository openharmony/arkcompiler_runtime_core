...
TEST_F(ClassGetStaticFieldCharTest, check_initialization0)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_char_test.Parent", &cls), ANI_OK);

    ani_static_field field {};
    ASSERT_EQ(env_->Class_FindStaticField(cls, "parentStaticField", &field), ANI_OK);

    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_char_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_char_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_char_test.Grandchild"));
    ani_char charValue {};
    ASSERT_EQ(env_->Class_GetStaticField_Char(cls, field, &charValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_char_test.Parent"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_char_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_char_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldCharTest, check_initialization1)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_char_test.Parent", &cls), ANI_OK);

    ani_class fieldClass {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_char_test.Child", &fieldClass), ANI_OK);
    ani_static_field field {};
    ...
    ASSERT_EQ(env_->Class_GetStaticField_Char(cls, field, &charValue), ANI_OK);
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_char_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_char_test.Child"));
    ASSERT_FALSE(IsRuntimeClassInitialized("class_get_static_field_char_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldCharTest, check_initialization2)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_char_test.Parent", &cls), ANI_OK);

    ani_class fieldClass {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_char_test.Grandchild", &fieldClass), ANI_OK);
    ani_static_field field {};
    ...
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_char_test.Parent"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_char_test.Child"));
    ASSERT_TRUE(IsRuntimeClassInitialized("class_get_static_field_char_test.Grandchild"));
}

TEST_F(ClassGetStaticFieldCharTest, check_initialization3)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_char_test.Child", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldCharTest, check_initialization4)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_char_test.Child", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldCharTest, check_initialization5)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_char_test.Child", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldCharTest, check_initialization6)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_char_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldCharTest, check_initialization7)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_char_test.Grandchild", &cls), ANI_OK);
...
TEST_F(ClassGetStaticFieldCharTest, check_initialization8)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("class_get_static_field_char_test.Grandchild", &cls), ANI_OK);
