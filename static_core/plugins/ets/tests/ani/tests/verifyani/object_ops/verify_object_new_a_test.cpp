...
{
    ani_object obj {};
    ASSERT_EQ(env_->c_api->Object_New_A(nullptr, cls_, ctor_, &obj, args_.data()), ANI_INVALID_ARGS);
    // clang-format off
...
{
    ani_object obj {};
    ASSERT_EQ(env_->c_api->Object_New_A(env_, nullptr, ctor_, &obj, args_.data()), ANI_INVALID_ARGS);
    // clang-format off
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
        {"cls", "ani_class", "reference is nullptr [ERROR]"},
        {"ctor", "ani_method", "ctor requires a class [ERROR]"},
        {"result", "ani_object *"},
        {"args", "ani_value *"},
        {"[0]", "ani_boolean"},
        {"[1]", "ani_char"},
...
{
    ani_object obj {};
    ASSERT_EQ(env_->c_api->Object_New_A(env_, cls_, nullptr, &obj, args_.data()), ANI_INVALID_ARGS);
    // clang-format off
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
        {"cls", "ani_class"},
        {"ctor", "ani_method", "ctor is nullptr [ERROR]"},
        {"result", "ani_object *"},
...
TEST_F(ObjectNewATest, wrong_ctor_1)
{
    ...
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
        {"cls", "ani_class"},
        {"ctor", "ani_method", "ctor not found (may be deleted or corrupted) [FATAL]"},
        {"result", "ani_object *"},
        {"args", "ani_value *", "method pointer is nullptr [ERROR]"},
    };
    // clang-format on
...
{
    ASSERT_EQ(env_->c_api->Object_New_A(env_, cls_, ctor_, nullptr, args_.data()), ANI_INVALID_ARGS);
    // clang-format off
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
        {"cls", "ani_class"},
...
{
    ani_object obj {};
    ASSERT_EQ(env_->c_api->Object_New_A(env_, cls_, ctor_, &obj, nullptr), ANI_INVALID_ARGS);
    // clang-format off
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
        {"cls", "ani_class"},
...
{
    ASSERT_EQ(env_->c_api->Object_New_A(nullptr, nullptr, nullptr, nullptr, nullptr), ANI_INVALID_ARGS);
    // clang-format off
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *", "env is nullptr [ERROR]"},
        {"cls", "ani_class", "reference is nullptr [ERROR]"},
