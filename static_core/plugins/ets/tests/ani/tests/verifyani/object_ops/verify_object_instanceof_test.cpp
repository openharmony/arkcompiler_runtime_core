...
class ObjectInstanceOfTest : public VerifyAniTest {};

TEST_F(ObjectInstanceOfTest, wrong_env)
{
    ani_class cls {};
...
TEST_F(ObjectInstanceOfTest, wrong_object_null)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("std.core.Object", &cls), ANI_OK);
...
TEST_F(ObjectInstanceOfTest, wrong_object_type)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("std.core.Object", &cls), ANI_OK);
    ani_ref undef {};
...
TEST_F(ObjectInstanceOfTest, wrong_type_null)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("std.core.Object", &cls), ANI_OK);
...
TEST_F(ObjectInstanceOfTest, wrong_type_type)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("std.core.Object", &cls), ANI_OK);
    ani_ref undef {};
    ...
    ani_boolean result {};
    ASSERT_EQ(env_->c_api->Object_InstanceOf(env_, cls, reinterpret_cast<ani_type>(undef), &result), ANI_ERROR);
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
        {"object", "ani_object"},
...
TEST_F(ObjectInstanceOfTest, wrong_result_ptr)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("std.core.Object", &cls), ANI_OK);
...
TEST_F(ObjectInstanceOfTest, success)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("std.core.Object", &cls), ANI_OK);

    ani_boolean result {};
    ASSERT_EQ(env_->Object_InstanceOf(cls, cls, &result), ANI_OK);
    ASSERT_EQ(result, ANI_TRUE);

    ASSERT_EQ(env_->Reference_Delete(cls), ANI_OK);
}

TEST_F(ObjectInstanceOfTest, throw_error)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("std.core.Object", &cls), ANI_OK);
