...
class ReferenceStrictEqualsTest : public VerifyAniTest {
public:
    void SetUp() override
    {
        VerifyAniTest::SetUp();
...
private:
    static void StackRefWithLocal(ani_env *env, ani_ref ref)
    {
        ...
        ASSERT_EQ(env->c_api->Reference_StrictEquals(env, ref, nullRef, &res), ANI_OK);
    ...
    static void StackRefWithGlobal(ani_env *env, ani_ref ref)
    {
        ...
        ASSERT_EQ(env->c_api->Reference_StrictEquals(env, ref, gref, &res), ANI_OK);
...
TEST_F(ReferenceStrictEqualsTest, wrong_env)
{
    ...
    ASSERT_EQ(env_->c_api->Reference_StrictEquals(nullptr, nullRef, nullRef, &res), ANI_ERROR);
...
TEST_F(ReferenceStrictEqualsTest, wrong_ref0)
{
    ani_boolean res = ANI_FALSE;
    ASSERT_EQ(env_->c_api->Reference_StrictEquals(env_, nullptr, nullRef, &res), ANI_ERROR);
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
...
TEST_F(ReferenceStrictEqualsTest, wrong_ref1)
{
    ani_boolean res = ANI_FALSE;
    ASSERT_EQ(env_->c_api->Reference_StrictEquals(env_, nullRef, nullptr, &res), ANI_ERROR);
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
        {"ref0", "ani_ref"},
...
TEST_F(ReferenceStrictEqualsTest, wrong_res)
{
    ASSERT_EQ(env_->c_api->Reference_StrictEquals(env_, nullRef, nullRef, nullptr), ANI_ERROR);
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
        {"ref0", "ani_ref"},
        {"ref1", "ani_ref"},
...
TEST_F(ReferenceStrictEqualsTest, wrong_all_args)
{
    ASSERT_EQ(env_->c_api->Reference_StrictEquals(nullptr, nullptr, nullptr, nullptr), ANI_ERROR);
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *", "called from incorrect the native scope"},
        {"ref0", "ani_ref", "wrong reference"},
        {"ref1", "ani_ref", "wrong reference"},
...
TEST_F(ReferenceStrictEqualsTest, throw_error)
{
    ThrowError();
    ani_boolean res {};
    ASSERT_EQ(env_->c_api->Reference_StrictEquals(env_, nullRef, nullRef, &res), ANI_ERROR);
    std::vector<TestLineInfo> testLines {
...
TEST_F(ReferenceStrictEqualsTest, global_ref)
{
    ani_ref gref1 {};
    ani_ref gref2 {};
    ...
    ani_boolean res {};
    ASSERT_EQ(env_->c_api->Reference_StrictEquals(env_, gref1, gref2, &res), ANI_OK);
    ASSERT_EQ(res, ANI_TRUE);

    ASSERT_EQ(env_->c_api->Reference_StrictEquals(env_, nullRef, gref2, &res), ANI_OK);
    ASSERT_EQ(res, ANI_TRUE);
...
TEST_F(ReferenceStrictEqualsTest, success)
{
    ...
    ASSERT_EQ(env_->c_api->Reference_StrictEquals(env_, nullRef, nullRef, &res), ANI_OK);
    ASSERT_EQ(res, ANI_TRUE);

    ASSERT_EQ(env_->c_api->Reference_StrictEquals(env_, nullRef, static_cast<ani_ref>(str), &res), ANI_OK);
