...
TEST_F(ClassCallStaticMethodBooleanTest, wrong_method_0)
{
    ...
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
        {"class", "ani_class"},
        {"static_method", "ani_static_method", "wrong type: ani_method, expected: ani_static_method [FATAL]"},
        {"result", "ani_boolean *"},
        {"...", "       "},
        {"[0]", "ani_boolean"},
        {"[1]", "ani_char"},
...
TEST_F(ClassCallStaticMethodBooleanTest, wrong_return_type)
{
    ...
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
        {"class", "ani_class"},
        {"static_method", "ani_static_method", "wrong return type: int, expected: boolean [ERROR]"},
        {"result", "ani_boolean *"},
        {"...", "       "},
        {"[0]", "ani_boolean"},
        {"[1]", "ani_char"},
