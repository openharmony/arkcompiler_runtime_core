...
TEST_F(DestroyEscapeLocalScopeTest, wrong_ref_0)
{
    ...
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
        {"ref", "ani_ref", "escape reference is null [ERROR]"},
        {"result", "ani_ref *"},
    };
    ASSERT_ERROR_ANI_ARGS_MSG("DestroyEscapeLocalScope", testLines);
    DestroyEscapeLocalScope();
...
TEST_F(DestroyEscapeLocalScopeTest, wrong_invalid_ref)
{
    CreateEscapeLocalScope();
    const long magicNumber = 0xdeadc0de;  // NOLINT(google-runtime-int)
    auto ref = bit_cast<ani_ref>(magicNumber);
    ani_ref result {};
    ASSERT_EQ(env_->c_api->DestroyEscapeLocalScope(env_, ref, &result), ANI_ERROR);
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
        {"ref", "ani_ref", "escape reference is invalid [FATAL]"},
        {"result", "ani_ref *"},
    };
    ASSERT_ERROR_ANI_ARGS_MSG("DestroyEscapeLocalScope", testLines);
    DestroyEscapeLocalScope();
...
TEST_F(DestroyEscapeLocalScopeTest, wrong_global_ref)
{
    CreateEscapeLocalScope();
    ani_ref ref {};
    ASSERT_EQ(env_->GetUndefined(&ref), ANI_OK);
    ...
    ani_ref result {};
    ASSERT_EQ(env_->c_api->DestroyEscapeLocalScope(env_, gref, &result), ANI_INCORRECT_REF);
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
        {"ref", "ani_ref", "wrong reference type: global reference, expected: local reference [ERROR]"},
        {"result", "ani_ref *"},
    };
    ASSERT_ERROR_ANI_ARGS_MSG("DestroyEscapeLocalScope", testLines);
...
TEST_F(DestroyEscapeLocalScopeTest, wrong_weak_ref)
{
    CreateEscapeLocalScope();
    ani_ref ref {};
    ASSERT_EQ(env_->GetUndefined(&ref), ANI_OK);
    ...
    ani_ref result {};
    ASSERT_EQ(env_->c_api->DestroyEscapeLocalScope(env_, reinterpret_cast<ani_ref>(wref), &result), ANI_INCORRECT_REF);
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
        {"ref", "ani_ref", "wrong reference type: weak reference, expected: local reference [ERROR]"},
        {"result", "ani_ref *"},
    };
    ASSERT_ERROR_ANI_ARGS_MSG("DestroyEscapeLocalScope", testLines);
...
TEST_F(DestroyEscapeLocalScopeTest, invalid_ref_after_destroy_scope)
{
    ...
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
        {"ref", "ani_ref", "reference not found (may be deleted, out of scope, or corrupted) [FATAL]"},
        {"result", "ani_boolean *"},
    };
...
TEST_F(DestroyEscapeLocalScopeTest, call_without_scope)
{
    ...
    ASSERT_ERROR_ANI_MSG(
        "DestroyEscapeLocalScope",
        "Illegal call DestroyEscapeLocalScope() without first calling CreateEscapeLocalScope() [FATAL]");
}
...
TEST_F(DestroyEscapeLocalScopeTest, call_with_wrong_scope)
{
    ...
    ASSERT_ERROR_ANI_MSG("DestroyEscapeLocalScope",
                         "Illegal call DestroyEscapeLocalScope() after calling CreateLocalScope() [FATAL]");
