...
class AnyGetByValueTest : public VerifyAniTest {};

TEST_F(AnyGetByValueTest, wrong_env)
{
    ani_class cls {};
...
TEST_F(AnyGetByValueTest, wrong_ref_null)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("std.core.Object", &cls), ANI_OK);

    ani_ref out {};
    ASSERT_EQ(env_->c_api->Any_GetByValue(env_, nullptr, cls, &out), ANI_ERROR);
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
...
TEST_F(AnyGetByValueTest, wrong_key_null)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("std.core.Object", &cls), ANI_OK);
...
TEST_F(AnyGetByValueTest, wrong_result_null)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("std.core.Object", &cls), ANI_OK);
...
TEST_F(AnyGetByValueTest, throw_error)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("std.core.Object", &cls), ANI_OK);
