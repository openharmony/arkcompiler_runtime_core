...
TEST_F(AnyCallTest, wrong_env)
{
    ...
    std::vector<TestLineInfo> testLines {
        ...
        {"func", "ani_ref", "Static types are not supported"},
        {"argc", "ani_size"},
        {"argv", "ani_ref *"},
        {"result", "ani_ref *"},
    };
...
TEST_F(AnyCallTest, wrong_func_null)
{
    ...
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},    {"func", "ani_ref", "reference is nullptr"},
...
TEST_F(AnyCallTest, wrong_result_null)
{
    ...
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},  {"func", "ani_ref", "Static types are not supported"},    {"argc", "ani_size"},
...
TEST_F(AnyCallTest, argv_null_with_argc_positive)
{
    ...
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},    {"func", "ani_ref", "Static types are not supported"},
