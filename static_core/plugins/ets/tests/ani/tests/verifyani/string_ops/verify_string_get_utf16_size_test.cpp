...
{
    ASSERT_EQ(env_->c_api->String_GetUTF16Size(env_, static_cast<ani_string>(null_), &size_), ANI_ERROR);
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
...
{
    ASSERT_EQ(env_->c_api->String_GetUTF16Size(env_, static_cast<ani_string>(undef_), &size_), ANI_ERROR);
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
...
TEST_F(StringGetUtf16SizeTest, err_input_string)
{
    ASSERT_EQ(env_->c_api->String_GetUTF16Size(env_, static_cast<ani_string>(err_), &size_), ANI_ERROR);
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
...
TEST_F(StringGetUtf16SizeTest, obj_input_string)
{
    ASSERT_EQ(env_->c_api->String_GetUTF16Size(env_, static_cast<ani_string>(obj_), &size_), ANI_ERROR);
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
...
TEST_F(StringGetUtf16SizeTest, cls_input_string)
{
    ASSERT_EQ(env_->c_api->String_GetUTF16Size(env_, reinterpret_cast<ani_string>(cls_), &size_), ANI_ERROR);
    std::vector<TestLineInfo> testLines {
        {"env", "ani_env *"},
