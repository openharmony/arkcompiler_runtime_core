...
TEST_F(NamespaceFindNamespaceTest, find_namespace01)
{
    ...
    ASSERT_EQ(env_->Namespace_FindNamespace(result, "B", &result), ANI_OK);
    ASSERT_NE(result, nullptr);
}
...
TEST_F(NamespaceFindNamespaceTest, find_namespace03)
{
    ...
    ASSERT_EQ(env_->Namespace_FindNamespace(result, "C", &result), ANI_OK);
    ASSERT_NE(result, nullptr);

    ASSERT_EQ(env_->Namespace_FindNamespace(result, "D", &result), ANI_OK);
    ASSERT_NE(result, nullptr);
}
...
TEST_F(NamespaceFindNamespaceTest, find_namespace04)
{
    ...
    ani_namespace nsB {};
    ASSERT_EQ(env_->Namespace_FindNamespace(ns, "A", &nsB), ANI_OK);
    ASSERT_NE(nsB, nullptr);

    ani_namespace result {};
    ASSERT_EQ(env_->Namespace_FindNamespace(nsB, "B", &result), ANI_OK);
    ASSERT_NE(result, nullptr);
}
...
TEST_F(NamespaceFindNamespaceTest, find_namespace05)
{
    ...
    ani_namespace tmp {};
    ASSERT_EQ(env_->Namespace_FindNamespace(ns, "D", &tmp), ANI_OK);
    ASSERT_NE(tmp, nullptr);

    ani_namespace result {};
    ASSERT_EQ(env_->Namespace_FindNamespace(ns, "E", &result), ANI_OK);
    ASSERT_NE(result, nullptr);
...
TEST_F(NamespaceFindNamespaceTest, find_namespace06)
{
    ...
    ani_namespace nsC {};
    ASSERT_EQ(env_->Namespace_FindNamespace(ns, "A.C", &nsC), ANI_OK);
...
TEST_F(NamespaceFindNamespaceTest, find_namespace07)
{
    ...
    ani_namespace nsC {};
    ASSERT_EQ(env_->c_api->Namespace_FindNamespace(nullptr, ns, "A.C", &nsC), ANI_INVALID_ARGS);

    ASSERT_EQ(env_->Namespace_FindNamespace(nullptr, "A.C", &nsC), ANI_INVALID_ARGS);
    ...
    ASSERT_EQ(env_->Namespace_FindNamespace(ns, "A.CA", &nsC), ANI_NOT_FOUND);

    ASSERT_EQ(env_->Namespace_FindNamespace(ns, "A.C", nullptr), ANI_INVALID_ARGS);
}
