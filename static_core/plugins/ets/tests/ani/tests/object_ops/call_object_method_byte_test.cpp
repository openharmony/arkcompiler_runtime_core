...
TEST_F(CallObjectMethodByteTest, object_call_method_byte_a)
{
    ani_object object {};
    ani_method method {};
    GetMethodAndObject("LA;", "byteMethod", "BB:B", &object, &method);
...
TEST_F(CallObjectMethodByteTest, call_Void_Param_Method)
{
    ani_object object {};
    ani_method method {};
    GetMethodAndObject("LA;", "byteMethodVoidParam", ":B", &object, &method);
...
TEST_F(CallObjectMethodByteTest, call_Multiple_Param_Method)
{
    ani_object object {};
    ani_method method {};
    GetMethodAndObject("LA;", "byteMethodMultipleParam", "BZFFB:B", &object, &method);
...
TEST_F(CallObjectMethodByteTest, call_Parent_Class_Void_Param_Method)
{
    ani_object object {};
    ani_method method {};
    GetMethodAndObject("LB;", "byteMethodVoidParam", ":B", &object, &method);
...
TEST_F(CallObjectMethodByteTest, call_Nested_Method)
{
    ani_object object {};
    ani_method method {};
    GetMethodAndObject("LA;", "nestedMethod", "BB:B", &object, &method);
...
TEST_F(CallObjectMethodByteTest, call_Recursion_Method)
{
    ani_object object {};
    ani_method method {};
    GetMethodAndObject("LA;", "recursionMethod", "B:B", &object, &method);
