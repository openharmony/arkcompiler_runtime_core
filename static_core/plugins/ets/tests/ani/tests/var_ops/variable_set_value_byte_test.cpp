...
TEST_F(VariableSetValueByteTest, set_byte_value)
{
    ani_namespace ns {};
    ...
    ASSERT_EQ(CallEtsFunction<ani_boolean>("checkByteValue", value), ANI_TRUE);
}

TEST_F(VariableSetValueByteTest, set_byte_value_invalid_value_type)
{
    ani_namespace ns {};
    ASSERT_EQ(env_->FindNamespace("Lanyns;", &ns), ANI_OK);
    ASSERT_NE(ns, nullptr);
...
TEST_F(VariableSetValueByteTest, set_byte_value_invalid_args_variable)
{
    ani_namespace ns {};
    ASSERT_EQ(env_->FindNamespace("Lanyns;", &ns), ANI_OK);
    ASSERT_NE(ns, nullptr);
