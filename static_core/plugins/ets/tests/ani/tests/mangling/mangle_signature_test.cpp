...
static constexpr std::string_view FOO1_UNION_SIGNATURE =
    "X{C{msig.A}C{std.core.String}C{std.core.Double}}:X{A{C{msig.A}}NX{C{msig.A}C{std.core.String}}}";
static constexpr std::string_view NAMESPACE_FOO1_UNION_SIGNATURE =
    "X{C{msig.rls.A}C{std.core.String}C{std.core.Double}}:X{A{C{msig.rls.A}}NX{C{msig.rls.A}C{std.core.String}}}";
...
TEST_F(MangleSignatureTest, FormatUnion_NewToRuntime)
{
    ...
    EXPECT_STREQ(desc.c_str(), "{ULa/b;[ILstd/core/Double;}:Lstd/core/Object;");
    ...
    EXPECT_STREQ(desc.c_str(), "{ULmsig/A;Lstd/core/Double;Lstd/core/String;}:Lstd/core/Object;");
}
