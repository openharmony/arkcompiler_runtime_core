...
class ValueArraySetGetRegionFloatTest : public AniGTestValueArrayOps {
protected:
...
TEST_F(ValueArraySetGetRegionFloatTest, SetFloatArrayRegionErrorTests)
{
    ani_valuearray_float array = nullptr;
    ASSERT_EQ(env_->ValueArray_New_Float(LENGTH_5, &array), ANI_OK);
    ani_float nativeBuffer[LENGTH_5] = {TEST_VALUE_1, TEST_VALUE_2, TEST_VALUE_3, TEST_VALUE_4, TEST_VALUE_5};
    const ani_size offset1 = -1;
    ASSERT_EQ(env_->ValueArray_SetRegion_Float(array, offset1, LENGTH_2, nativeBuffer), ANI_OUT_OF_RANGE);
    ASSERT_EQ(env_->ValueArray_SetRegion_Float(array, OFFSET_5, LENGTH_10, nativeBuffer), ANI_OUT_OF_RANGE);
    ASSERT_EQ(env_->ValueArray_SetRegion_Float(array, OFFSET_0, LENGTH_5, nativeBuffer), ANI_OK);
}

TEST_F(ValueArraySetGetRegionFloatTest, GetFloatArrayRegionErrorTests)
{
    ani_valuearray_float array = nullptr;
    ASSERT_EQ(env_->ValueArray_New_Float(LENGTH_5, &array), ANI_OK);
    ani_float nativeBuffer[LENGTH_5] = {TEST_VALUE_1, TEST_VALUE_2, TEST_VALUE_3, TEST_VALUE_4, TEST_VALUE_5};
    ASSERT_EQ(env_->ValueArray_GetRegion_Float(array, OFFSET_0, LENGTH_1, nullptr), ANI_INVALID_ARGS);
    ASSERT_EQ(env_->ValueArray_GetRegion_Float(array, OFFSET_5, LENGTH_10, nativeBuffer), ANI_OUT_OF_RANGE);
    ASSERT_EQ(env_->ValueArray_GetRegion_Float(array, OFFSET_0, LENGTH_1, nativeBuffer), ANI_OK);
}

TEST_F(ValueArraySetGetRegionFloatTest, GetRegionFloatTest)
{
    const auto array =
        static_cast<ani_valuearray_float>(CallEtsFunction<ani_ref>("valuearray_region_float_test", "getArray"));

    ani_float nativeBuffer[LENGTH_5] = {0.0F};
    const float epsilon = 1e-6;  // Define acceptable tolerance
    ASSERT_EQ(env_->ValueArray_GetRegion_Float(array, OFFSET_0, LENGTH_5, nativeBuffer), ANI_OK);
...
TEST_F(ValueArraySetGetRegionFloatTest, SetRegionFloatTest)
{
    const auto array =
        static_cast<ani_valuearray_float>(CallEtsFunction<ani_ref>("valuearray_region_float_test", "getArray"));
    ani_float nativeBuffer1[LENGTH_5] = {TEST_UPDATE_1, TEST_UPDATE_2, TEST_UPDATE_3};
    ASSERT_EQ(env_->ValueArray_SetRegion_Float(array, OFFSET_2, LENGTH_3, nativeBuffer1), ANI_OK);
    ASSERT_EQ(CallEtsFunction<ani_boolean>("valuearray_region_float_test", "checkArray", array), ANI_TRUE);
}

TEST_F(ValueArraySetGetRegionFloatTest, CheckChangeFromManagedRegionFloatTest)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("valuearray_region_float_test.ArrayClass", &cls), ANI_OK);
    ...
    auto array = reinterpret_cast<ani_valuearray_float>(ref);
...
TEST_F(ValueArraySetGetRegionFloatTest, CheckChangeFromApiRegionFloatTest)
{
    ani_class cls {};
    ASSERT_EQ(env_->FindClass("valuearray_region_float_test.ArrayClass", &cls), ANI_OK);
    ASSERT_NE(cls, nullptr);
    ...
    ASSERT_EQ(env_->ValueArray_SetRegion_Float(array, OFFSET_2, LENGTH_3, nativeBuffer), ANI_OK);
...
TEST_F(ValueArraySetGetRegionFloatTest, GetSpecialValueToArrayTest)
{
    const auto array =
        static_cast<ani_valuearray_float>(CallEtsFunction<ani_ref>("valuearray_region_float_test", "getSpecialArray"));

    std::array<ani_float, LENGTH_6> nativeBuffer = {};
    ASSERT_EQ(env_->ValueArray_GetRegion_Float(array, OFFSET_0, LENGTH_6, nativeBuffer.data()), ANI_OK);
...
TEST_F(ValueArraySetGetRegionFloatTest, SetSpecialValueToArrayTest)
{
    ani_valuearray_float array = nullptr;
    ASSERT_EQ(env_->ValueArray_New_Float(LENGTH_6, &array), ANI_OK);
    ...
    ASSERT_EQ(env_->ValueArray_SetRegion_Float(array, OFFSET_0, LENGTH_6, nativeBuffer.data()), ANI_OK);

    std::array<ani_float, LENGTH_6> nativeBuffer2 = {};
    ASSERT_EQ(env_->ValueArray_GetRegion_Float(array, OFFSET_0, LENGTH_6, nativeBuffer2.data()), ANI_OK);
...
TEST_F(ValueArraySetGetRegionFloatTest, SetGetUnionToArrayTest)
{
    ani_valuearray_float array = nullptr;
    ASSERT_EQ(env_->ValueArray_New_Float(LENGTH_5, &array), ANI_OK);
    ...
    std::array<ani_float, LENGTH_5> nativeBuffer = {TEST_VALUE_1, TEST_VALUE_2, TEST_VALUE_3, TEST_VALUE_4,
                                                    TEST_VALUE_5};
    ASSERT_EQ(env_->ValueArray_SetRegion_Float(array, OFFSET_0, LENGTH_5, nativeBuffer.data()), ANI_OK);

    std::array<ani_float, LENGTH_5> nativeBuffer2 = {};
    ASSERT_EQ(env_->ValueArray_GetRegion_Float(array, OFFSET_0, LENGTH_5, nativeBuffer2.data()), ANI_OK);
    ...
    std::array<ani_float, LENGTH_5> nativeBuffer3 = {TEST_VALUE_1, TEST_VALUE_3, TEST_VALUE_5, TEST_VALUE_2,
                                                     TEST_VALUE_4};
    ASSERT_EQ(env_->ValueArray_SetRegion_Float(array, OFFSET_0, LENGTH_5, nativeBuffer3.data()), ANI_OK);
...
TEST_F(ValueArraySetGetRegionFloatTest, SetGetStabilityToArrayTest)
{
    ani_valuearray_float array = nullptr;
    ASSERT_EQ(env_->ValueArray_New_Float(LENGTH_5, &array), ANI_OK);
