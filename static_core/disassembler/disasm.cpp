...
void Disassemble(const std::string &input_file, const std::string &output_file, const std::string &profile,
                 const bool with_separators, const bool verbose, const bool quiet, const bool skip_strings)
{
    ...
    disasm.Serialize(res_pa, with_separators, verbose);
    res_pa.close();
}
...
int main(int argc, const char **argv)
{
    ...
    Disassemble(input_file.GetValue(), output_file.GetValue(), profile.GetValue(), with_separators.GetValue(),
                verbose.GetValue(), quiet.GetValue(), skip_strings.GetValue());
